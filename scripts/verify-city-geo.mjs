...
const CITY_GATES = {
  busan: {
    ...
    streamCourses: [
      {
        // 유로 pin은 스냅샷 river 마스크 중앙선(160m 밴드 평균)에서 추출 — OSM relation
        // 6994989 실유로와 일치(Codex-1 #151 반박 수용: 구 pin이 중류에서 600~800m 동측
        // 이탈, 실제 유로는 동래 서편 129.0785로 휨). 35.205 부근은 마스크 갭 구간 —
        // 보간 pin 유지(하천 연속성 자체가 게이트 대상).
        name: '온천천', presenceMin: 0.8, windowTiles: 4,
        pts: [[129.0893, 35.2308], [129.0884, 35.2237], [129.0869, 35.2208], [129.0849, 35.2179], [129.0817, 35.2151], [129.0805, 35.2136], [129.0787, 35.2107], [129.0785, 35.2050], [129.0792, 35.2007], [129.0802, 35.1993], [129.0950, 35.1978], [129.1028, 35.1949], [129.1083, 35.1906]],
      },
    ],
    reportCourses: [
