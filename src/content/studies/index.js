...
import JP_ART_PILGRIMAGE from './japan/artPilgrimage.js';
import JP_FAITH_FESTIVALS from './japan/faithFestivals.js';
...
import FR_CULTURE from './france/culture.js';
import FR_SOCIETY from './france/society.js';
...
export const STUDY_COUNTRIES = Object.freeze([
  Object.freeze({
    ...
    docs: Object.freeze([JP_OVERVIEW, JP_HISTORY_PREMODERN, JP_HISTORY_MODERN, JP_HISTORY_ROADS, JP_ECONOMY, JP_CULTURE, JP_FOOD_DEEP, JP_LITERATURE_TRAVEL, JP_ART_PILGRIMAGE, JP_FAITH_FESTIVALS, JP_SOCIETY, JP_LIFE]),
  }),
  Object.freeze({
    id: 'korea',
    nameKo: '한국학',
  ...
  Object.freeze({
    ...
    docs: Object.freeze([FR_OVERVIEW, FR_HISTORY_PREMODERN, FR_HISTORY_MODERN, FR_ECONOMY, FR_SOCIETY, FR_CULTURE, FR_FRANCOPHONIE]),
  }),
]);
