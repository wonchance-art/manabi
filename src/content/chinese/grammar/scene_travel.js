...
const chapters = [
  {
    ...
    drills: [
      ...
      { id: "h117-d7", type: "choice", listen: "请出示您的护照和机票。", prompt: "직원의 요청을 듣고 뜻을 고르세요.", choices: ["여권과 항공권을 보여 주세요", "짐을 저울에 올려 주세요", "줄을 서 주세요"], answer: "여권과 항공권을 보여 주세요" },
      { id: "h117-d8", type: "choice", listen: "您带了多少现金？", prompt: "심사관의 질문을 듣고 뜻을 고르세요.", choices: ["현금을 얼마나 가지고 있나요?", "어디에서 환전하나요?", "신용카드가 있나요?"], answer: "현금을 얼마나 가지고 있나요?" },
    ],
    writing: {
  ...
  },
  {
    ...
    drills: [
      ...
      { id: "h118-d7", type: "choice", listen: "去市区的大巴十分钟一班。", prompt: "안내를 듣고 뜻을 고르세요.", choices: ["시내행 버스는 10분에 한 대씩 있어요", "시내행 버스는 10시에 출발해요", "시내행 버스는 오늘 운행하지 않아요"], answer: "시내행 버스는 10분에 한 대씩 있어요" },
      { id: "h118-d8", type: "choice", listen: "在下一站换二号线。", prompt: "환승 안내를 듣고 뜻을 고르세요.", choices: ["다음 역에서 2호선으로 갈아타세요", "이번 역에서 내리세요", "2번 출구로 나가세요"], answer: "다음 역에서 2호선으로 갈아타세요" },
    ],
    writing: {
  ...
  },
  {
    ...
    drills: [
      ...
      { id: "h119-d7", type: "choice", listen: "早餐从七点到十点。", prompt: "프런트의 안내를 듣고 고르세요.", choices: ["아침 식사는 7시부터 10시까지예요", "아침 식사는 10시에 시작해요", "아침 식사가 제공되지 않아요"], answer: "아침 식사는 7시부터 10시까지예요" },
      { id: "h119-d8", type: "choice", listen: "退房时间是中午十二点。", prompt: "체크아웃 안내를 듣고 고르세요.", choices: ["체크아웃은 정오 12시예요", "체크인은 12시부터예요", "연장은 안 돼요"], answer: "체크아웃은 정오 12시예요" },
    ],
    writing: {
  ...
  },
  {
    ...
    drills: [
      ...
      { id: "h120-d7", type: "choice", listen: "我们马上派人过去。", prompt: "프런트의 답을 듣고 뜻을 고르세요.", choices: ["바로 사람을 보내 드릴게요", "내일이나 가능해요", "저희가 갈 수는 없어요"], answer: "바로 사람을 보내 드릴게요" },
      { id: "h120-d8", type: "choice", listen: "给您换到八楼的房间。", prompt: "안내를 듣고 뜻을 고르세요.", choices: ["8층 방으로 바꿔 드릴게요", "8호실은 예약이 찼어요", "8시에 방을 바꿔 드릴게요"], answer: "8층 방으로 바꿔 드릴게요" },
    ],
    writing: {
  ...
  },
  {
    ...
    drills: [
      ...
      { id: "h121-d7", type: "choice", listen: "我们的招牌菜是烤鸭。", prompt: "종업원의 추천을 듣고 고르세요.", choices: ["대표 요리는 카오야예요", "오늘은 카오야가 다 떨어졌어요", "카오야는 아주 매워요"], answer: "대표 요리는 카오야예요" },
      { id: "h121-d8", type: "choice", listen: "现在人多，要等二十分钟。", prompt: "안내를 듣고 뜻을 고르세요.", choices: ["지금 붐벼서 20분 기다려야 해요", "자리가 바로 있어요", "20분 뒤에 문을 닫아요"], answer: "지금 붐벼서 20분 기다려야 해요" },
    ],
    writing: {
  ...
  },
  {
    ...
    drills: [
      ...
      { id: "h122-d7", type: "choice", listen: "现金还是刷卡？", prompt: "계산대의 질문을 듣고 고르세요.", choices: ["현금인가요, 카드인가요?", "영수증 필요하세요?", "포장해 드릴까요?"], answer: "현금인가요, 카드인가요?" },
      { id: "h122-d8", type: "choice", listen: "找您十二块。", prompt: "듣고 뜻을 고르세요.", choices: ["거스름돈 12위안입니다", "12위안이 모자라요", "12번 테이블로 가세요"], answer: "거스름돈 12위안입니다" },
    ],
    writing: {
