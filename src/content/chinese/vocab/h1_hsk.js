  ...
  themes: [
    {
      ...
      words: [
        ...
        { zh: "多少", pinyin: "duō shǎo", ko: "얼마, 몇 (큰 수를 물음)", pos: "대명사", hanja: "다소(多少) — '많을 다 + 적을 소', 글자 그대로 '얼마'예요.", ex: { zh: "这个多少钱？", pinyin: "zhège duō shǎo qián", ko: "이거 얼마예요?" } },
      ],
    },
    {
      name: "HSK1 보강 — 동사·표현",
      ...
      words: [
        ...
        { zh: "没关系", pinyin: "méi guān xi", ko: "괜찮아요, 상관없어요", pos: "표현", hanja: "관계(關係) — '관계없다', 즉 괜찮아요.", ex: { zh: "没关系，别担心。", pinyin: "méi guān xi, bié dān xīn", ko: "괜찮아요, 걱정 마세요." } },
    ...
    },
    {
      ...
      icon: "🟦",
      words: [
        { zh: "电脑", pinyin: "diàn nǎo", ko: "컴퓨터", pos: "명사", hanja: "전뇌(電腦) — '번개 전 + 뇌 뇌', 즉 '전자 두뇌' = 컴퓨터.", ex: { zh: "这是我的电脑。", pinyin: "zhè shì wǒ de diàn nǎo", ko: "이건 제 컴퓨터예요." } },
        { zh: "汉语", pinyin: "Hàn yǔ", ko: "중국어", pos: "명사", hanja: "한어(漢語) — '한나라 한 + 말씀 어', 한족의 말 = 중국어.", ex: { zh: "我学汉语。", pinyin: "wǒ xué Hànyǔ", ko: "저는 중국어를 배워요." } },
        { zh: "饭馆", pinyin: "fàn guǎn", ko: "식당, 음식점", pos: "명사", hanja: "반관(飯館) — '밥 반 + 집 관'.", ex: { zh: "我们去饭馆吃饭。", pinyin: "wǒmen qù fàn guǎn chī fàn", ko: "우리 식당에 가서 밥 먹어요." } },
        { zh: "小姐", pinyin: "xiǎo jie", ko: "아가씨, ~양 (젊은 여성 호칭)", pos: "명사", hanja: "소저(小姐) — '작을 소 + 누이 저'. 젊은 여성을 부르는 호칭이에요.", ex: { zh: "王小姐是老师。", pinyin: "Wáng xiǎojie shì lǎoshī", ko: "왕 양은 선생님이에요." } },
        { zh: "椅子", pinyin: "yǐ zi", ko: "의자", pos: "명사", hanja: "의자(椅子) — '椅'가 의자 의. 한국어 '의자'와 같아요.", ex: { zh: "这把椅子很好。", pinyin: "zhè bǎ yǐzi hěn hǎo", ko: "이 의자는 좋아요." } },
        { zh: "桌子", pinyin: "zhuō zi", ko: "탁자, 책상", pos: "명사", hanja: "탁자(桌子) — '桌'이 탁자 탁. 한국어 '탁자'와 같아요.", ex: { zh: "桌子上有书。", pinyin: "zhuōzi shàng yǒu shū", ko: "탁자 위에 책이 있어요." } },
        ...
        { zh: "前面", pinyin: "qián miàn", ko: "앞, 앞쪽", pos: "명사", hanja: "전면(前面) — '앞 전 + 낯 면'. 글자 그대로 '앞쪽'.", ex: { zh: "前面有一个饭馆。", pinyin: "qiánmiàn yǒu yí ge fànguǎn", ko: "앞쪽에 식당이 하나 있어요." } },
        { zh: "后面", pinyin: "hòu mian", ko: "뒤, 뒤쪽", pos: "명사", hanja: "후면(後面) — '뒤 후 + 낯 면'. 글자 그대로 '뒤쪽'.", ex: { zh: "桌子后面有椅子。", pinyin: "zhuōzi hòumian yǒu yǐzi", ko: "탁자 뒤에 의자가 있어요." } },
        { zh: "上午", pinyin: "shàng wǔ", ko: "오전", pos: "명사", hanja: "상오(上午) — '윗 상 + 낮 오'. 정오 이전 = 오전.", ex: { zh: "上午我有课。", pinyin: "shàngwǔ wǒ yǒu kè", ko: "오전에 저는 수업이 있어요." } },
        { zh: "下午", pinyin: "xià wǔ", ko: "오후", pos: "명사", hanja: "하오(下午) — '아래 하 + 낮 오'. 정오 이후 = 오후.", ex: { zh: "下午我去学校。", pinyin: "xiàwǔ wǒ qù xuéxiào", ko: "오후에 저는 학교에 가요." } },
    ...
    },
    {
      ...
      words: [
        ...
        { zh: "什么", pinyin: "shén me", ko: "무엇, 무슨", pos: "대명사", ex: { zh: "这是什么？", pinyin: "zhè shì shénme", ko: "이건 뭐예요?" } },
        { zh: "谁", pinyin: "shéi", ko: "누구", pos: "대명사", ex: { zh: "他是谁？", pinyin: "tā shì shéi", ko: "그는 누구예요?" } },
        { zh: "怎么", pinyin: "zěn me", ko: "어떻게, 왜", pos: "대명사", ex: { zh: "这个字怎么读？", pinyin: "zhège zì zěnme dú", ko: "이 글자는 어떻게 읽어요?" } },
        { zh: "怎么样", pinyin: "zěn me yàng", ko: "어때요?, 어떻습니까?", pos: "대명사", ex: { zh: "今天天气怎么样？", pinyin: "jīntiān tiānqì zěnmeyàng", ko: "오늘 날씨 어때요?" } },
      ],
    },
    {
