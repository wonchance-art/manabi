...

  {
    ...
    sections: [
      ...
      },
      {
        ...
        body:
          "최대 함정: qui/que는 영어 who/which처럼 **선행사가 사람이냐 사물이냐로 갈리지 않아요**. 기준은 단 하나, **관계절 안에서 빠진 자리가 주어냐 목적어냐**예요.\n\n" +
          "실전 판별법: 관계대명사 **바로 뒤**를 보세요. **동사가 바로 오면 qui**(주어가 빠졌으니까), **주어+동사가 오면 que**(목적어가 빠졌으니까). 이 두 줄이면 90%가 해결돼요.",
        table: {
