    ...
    sections: [
      {
        ...
        body:
          "프랑스어 가정문은 '현실에서 얼마나 멀어지는가'에 따라 세 단계로 정리돼요. 그리고 이 시스템은 **영어의 if 1·2·3형식과 거의 완벽하게 1:1 대응**해요. 영어 가정법을 배워둔 분이라면 이 챕터는 '번역표 한 장'으로 끝납니다.\n\n" +
          "공통 원리는 하나: **si절의 시제를 한 칸씩 과거로 밀수록 현실에서 멀어진다.** 현재(실현 가능) → 반과거(현재의 비현실) → 대과거(과거의 비현실, 돌이킬 수 없음).",
        table: {
          caption: "가정문 3종 세트",
      ...
      },
      {
        ...
        body:
          "조건이 **현실적으로 가능**할 때는 si절에 현재를 쓰고, 주절에는 미래·현재·명령문이 자유롭게 와요.\n\n" +
          "여기서 가정법 특유의 형태는 하나도 안 나와요 — 이미 아는 시제의 조합일 뿐이죠. si + il(s)는 **s'il(s)**로 축약되지만, si + elle은 si elle 그대로라는 것만 챙기세요.",
        examples: [
