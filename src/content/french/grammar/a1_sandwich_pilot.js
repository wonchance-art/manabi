...
const chapters = [
  {
    ...
    sections: [
      ...
      // ③ 문법 패턴 (patternExplanation) — v1 호환 섹션
      {
        ...
        tip: "🎴 문화 한 스푼: 같은 에스프레소도 au comptoir(카운터에 서서)가 en terrasse(테라스)보다 싼 게 파리 카페의 오랜 규칙이에요 — 메뉴판에 두 가격이 나란히 적혀 있어요.",
        body:
  ...
  // ========================================
  {
    ...
    sections: [
      ...
      // ③ 문법 패턴 (patternExplanation) — v1 호환 섹션
      {
        ...
        tip: "🎴 문화 한 스푼: 프랑스에서는 가벼운 증상이면 의사보다 약국부터 가는 게 관행이에요 — 약사가 1차 상담을 해 주고, 필요하면 의사 진료를 권해 줘요.",
        body:
