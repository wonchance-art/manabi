...
const chapters = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        tip:
          "목적을 길게 설명하기보다 tourisme, études, travail처럼 질문에 맞는 핵심어부터 말해요. 🎴 문화 한 스푼: 프랑스에서는 심사대든 상점이든 Bonjour로 시작하고 Merci, bonne journée로 끝내는 게 기본 예절이에요 — 인사를 건너뛰면 용건도 꼬이기 쉬워요.",
      },
      {
        type: "patternExplanation",
...

  {
    ...
    sections: [
      ...
      },
      {
        ...
        tip:
          "quai 번호는 출발 직전에 바뀔 수 있으니 표와 전광판을 함께 확인해요. 🎴 문화 한 스푼: 프랑스 역에서는 승강장이 출발 20분 전쯤에야 전광판에 떠요 — 다들 전광판 아래서 기다리다 번호가 뜨면 일제히 움직이는 게 역의 풍경이에요.",
      },
      {
        type: "patternExplanation",
...

  {
    ...
    sections: [
      ...
      },
      {
        ...
        tip:
          "장소와 시각을 한꺼번에 놓치지 않도록 조식과 체크아웃을 각각 한 문장으로 물어요. 🎴 문화 한 스푼: 체크인 때 taxe de séjour(숙박세)를 1인 1박 몇 유로씩 현장에서 따로 받는 게 프랑스의 표준이에요 — 추가 요금이 아니라 제도예요.",
      },
      {
        type: "authenticReplay",
        heading: "같은 대화, 이제 다시 읽어 보기",
...

  {
    ...
    sections: [
      ...
      },
      {
        ...
        tip:
          "필요한 수량을 먼저 확인해 deux serviettes처럼 명사 앞에 숫자를 붙여요. 🎴 문화 한 스푼: 프랑스의 1층은 rez-de-chaussée(RDC)이고 premier étage는 한국식 2층이에요 — 방 층수를 들을 때 한 층씩 밀리지 않게 조심해요.",
      },
      {
        type: "patternExplanation",
...

  {
    ...
    sections: [
      ...
      },
      {
        ...
        tip:
          "탄산수나 병물이 필요한 경우에는 원하는 종류와 가격을 메뉴에서 확인한 뒤 주문해요. 🎴 문화 한 스푼: 프랑스 식당에서는 une carafe d'eau(수돗물 한 병)를 무료로 요청할 수 있어요 — 법으로 보장된 권리라 병물 대신 당당히 주문해도 돼요.",
      },
      {
        type: "authenticReplay",
        heading: "같은 대화, 이제 다시 읽어 보기",
...

  {
    ...
    sections: [
      ...
      },
      {
        ...
        tip:
          "계산서를 받은 뒤 주문한 항목과 금액을 확인하고 결제 방법을 말해요. 🎴 문화 한 스푼: 프랑스 계산서에는 service compris(봉사료 포함)가 원칙이라 팁이 의무가 아니에요 — 만족했다면 동전 몇 개를 남기는 정도가 관례예요.",
      },
      {
        type: "patternExplanation",
