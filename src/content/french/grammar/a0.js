    ...
    sections: [
      {
        ...
        tip: "소리가 살아나며 음가가 바뀌기도 해요 — s가 [z]로 되는 게 압도적으로 흔해요. 전체 음가 표는 A1 «자음 이어붙이기» 챕터에서 정리해요.",
      },
      {
      ...
      {
        heading: "규칙이 정해져 있다 — 전체 지도는 A1에서",
        pattern: "반드시 잇는 자리 · 절대 안 되는 자리가 문법으로 정해져 있다",
        patternKo: "지금은 '규칙이 존재한다'는 감각만 — 체계는 A1 리에종 챕터에서",
        body:
          "리에종은 기분 따라 하는 게 아니라 **반드시 하는 자리와 절대 하면 안 되는 자리가 문법으로 정해져** 있어요. 맛보기 둘만 볼게요 — 관사+명사는 필수(les amis 레자미), **et(그리고) 뒤는 금지**(et un café '에 엉 까페').\n\n" +
          "의무·선택·금지의 **전체 지도**는 A1 «자음 이어붙이기 — 듣기 편하게» 챕터에서 체계로 배워요. 여기서는 '그런 규칙이 있구나'만 챙기면 충분해요.",
        examples: [
