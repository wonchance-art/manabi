    ...
    sections: [
      {
        ...
        tip: "묵음 끝자음은 '죽은 글자'가 아니라, 여성형을 만들거나(petit→petite) 뒤 단어와 연음될 때(다음 챕터!) 되살아나는 잠자는 글자입니다. 사실 한국에서 이미 쓰고 있어요 — 쁘띠(petit)의 끝 t, 그랑프리(grand prix)의 d와 x가 묵음인 채로 들어온 발음이거든요.",
      },
      {
        heading: "h는 언제나 묵음",
...

  {
    ...
    sections: [
      ...
      },
      {
        ...
        tip: "단어장에 남성=파랑, 여성=빨강 색 코드를 정해두는 것도 좋지만, 브랜드명도 훌륭한 암기 카드예요. 라네즈(la neige, 눈)는 여성이라 la가 맞고, 마몽드(Ma Monde)는 monde가 남성이라 문법대로라면 mon monde — 이 '틀린 성'이 오히려 기억에 남죠. 성은 '이해'가 아니라 '습관'의 영역입니다.",
      },
    ],
  },

  {
    ...
    sections: [
      ...
      },
      {
        ...
        etym: "le/la는 라틴어 지시사 ille/illa(저것)가 닳아서 된 말로, 스페인어 el/la, 이탈리아어 il/la도 같은 후손이에요. 그리고 이미 한국 마트에 진열돼 있죠 — 라네즈(la neige, 여성 단수)의 la, 뚜레쥬르(Tous les jours, 복수)의 les가 전부 이 정관사예요. 브랜드명을 보며 '왜 la지? 왜 les지?'를 따져보면 그게 곧 관사 공부입니다.",
      },
      {
...

  {
    ...
    sections: [
      ...
      },
      {
        ...
        pattern: "tu = 반말 (친구·가족) · vous = 존댓말 + 복수 '여러분'",
        body:
          "**tu**는 친구·가족·아이에게, **vous**는 처음 만난 사람·윗사람·격식 상황에서 써요. 한국어 **반말/존댓말 감각 그대로**라 우리에겐 큰 어드밴티지예요.\n\n" +
          "'말 놓다'에 해당하는 동사(tutoyer)가 따로 있을 만큼 이 전환은 관계의 이정표예요. 확신이 없으면 무조건 vous — 한국에서처럼요.",
        examples: [
