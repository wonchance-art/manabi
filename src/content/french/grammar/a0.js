...
const chapters = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        tip: "악상은 '있으면 좋은 것'이 아니라 철자의 일부예요. café를 cafe로 쓰면 틀린 철자입니다. 예전 표기에는 대문자 악상을 생략한 Ecole도 보이지만, 현대 표준은 대문자에도 악상을 유지해요(École).",
      },
      {
        heading: "한 가지 더 — 합자 œ",
        pattern: "o + e → œ = [œ]",
    ...
    sections: [
      {
        ...
        body:
          ...
          "동사가 맨 끝에 오는 한국어(나는 사과를 먹는다)와 달리, 프랑스어는 '나는 먹는다 사과를' 순서예요. 어순만큼은 영어 감각을 그대로 가져다 쓰면 됩니다.",
        examples: [
      ...
      },
      {
        ...
        vsEn: "영어도 한국어도 형용사가 명사 앞이죠(red wine, 빨간 와인). 프랑스어만 '와인 빨간' 순서라 두 언어의 습관이 모두 방해가 돼요. '프랑스어는 명사부터, 꾸밈은 나중'이라고 새겨두세요.",
      },
      {
