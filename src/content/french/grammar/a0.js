...
const chapters = [
...

  {
    ...
    drills: [
      ...
      { id: "a004-d4", type: "choice", prompt: "quatre(4) — 어떻게 읽을까요?", choices: ["꺄트흐", "꽈트레", "뀌아트르"], answer: "꺄트흐", hint: "qu=[끄]·끝 e 묵음", speak: "quatre" },
    ...
    sections: [
      ...
      },
      {
        ...
        tip: "예고 하나 — 여기서 배운 묵음 끝 자음이 모음 앞에서 되살아나 다음 단어와 이어지기도 해요(vous avez 부자베). 이 '소리 잇기(리에종)' 규칙은 A1 발음 챕터에서 본격적으로 배워요.",
      },
    ],
  },

  {
    ...
    drills: [
      ...
      { id: "a007-d11", type: "choice", prompt: "matin(아침) — 어떻게 읽을까요?", choices: ["마땡", "마틴", "마탕"], answer: "마땡", hint: "in=[앵]", speak: "matin" },
      { id: "a007-d12", type: "choice", prompt: "fromage(치즈) — 어떻게 읽을까요?", choices: ["프호마주", "프로마게", "프호마쥐"], answer: "프호마주", hint: "g+e=[주]·끝 e 묵음", speak: "fromage" },
      { id: "a007-d13", type: "choice", prompt: "dimanche(일요일) — 어떻게 읽을까요?", choices: ["디망슈", "디만체", "디망셰"], answer: "디망슈", hint: "an=[엉]·ch=[슈]·끝 e 묵음", speak: "dimanche" },
      { id: "a007-d14", type: "choice", prompt: "chocolat(초콜릿) — 어떻게 읽을까요?", choices: ["쇼꼴라", "초콜랏", "쇼꼴라트"], answer: "쇼꼴라", hint: "ch=[슈]·끝 t 묵음", speak: "chocolat" },
      ...
      { id: "a007-d20", type: "choice", prompt: "jambon(햄) — 어떻게 읽을까요?", choices: ["장봉", "잠본", "얌봉"], answer: "장봉", hint: "am도 on도 비모음 — 코로 두 번", speak: "jambon" },
      ...
      { id: "a007-d24", type: "choice", prompt: "thé(차) — 어떻게 읽을까요?", choices: ["떼", "테흐", "쎄"], answer: "떼", hint: "th=[뜨]·é=[에]", speak: "thé" },
    ],
    sections: [
      {
