...

  {
    ...
    sections: [
      ...
      },
      {
        ...
        body:
          "프랑스어 r는 한국어 'ㄹ'도, 영어 r도 아니에요. **목젖 근처를 좁혀 공기를 마찰시키는 소리** [ʁ]예요.\n\n" +
          "연습법: 가글할 때 목 안쪽이 떨리는 위치를 기억하세요. 그 위치에서 물 없이 약하게 'ㅎ'를 긁듯 내면 [ʁ]에 가까워요. 한국어 '흐'에 살짝 긁히는 소리를 더한 느낌이라, 한글로 굳이 적으면 'ㄹ'보다 'ㅎ'에 가까워요 (Paris ≈ 빠히).\n\n" +
          "처음부터 완벽할 필요 없어요. 'ㅎ'로 대체해도 'ㄹ'로 내는 것보다 훨씬 잘 통합니다.",
        examples: [
    ...
    sections: [
      {
        ...
        body:
          "평소에는 묵음이던 단어 끝 자음이, **다음 단어가 모음으로 시작하면 살아나서 이어 발음**돼요. 이걸 **리에종(liaison)**이라고 해요.\n\n" +
          "vous는 혼자서는 [vu]지만, vous avez는 [vu-za-ve] — s가 [z]로 살아나죠.\n\n" +
          "사실 이건 한국어 화자에게 아주 익숙한 원리예요. 한국어 연음과 똑같거든요: '옷이'를 '오시'로, '꽃을'을 '꼬츨'로 읽는 것처럼, 받침이 다음 모음으로 넘어가는 거예요.",
        examples: [
