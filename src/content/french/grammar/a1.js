...
export default [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        body:
          "**être**(~이다, 있다)는 프랑스어에서 가장 많이 쓰는 동사예요. 영어 be처럼 인칭마다 모양이 완전히 달라지는 불규칙 동사라서, 표를 통째로 입에 붙여야 해요.\n\n" +
          "발음 포인트: tu es와 il est는 둘 다 [ɛ]로 **소리가 같아요**. 그리고 vous êtes는 리에종으로 '부제트'[vuzɛt]가 됩니다.",
        table: {
          caption: "être 직설법 현재",
          headers: ["인칭", "형태", "발음"],
          rows: [
      ...
      },
      {
        ...
        body:
          "**c'est**(= ce + est)는 '이것은/그것은/그 사람은 ~이다'를 한 방에 처리하는 만능 표현이에요. 사물 소개, 사람 소개, 감상 표현까지 전부 커버해요.\n\n" +
      ...
      },
      {
        ...
        body:
          "교과서는 '우리 = nous'라고 가르치지만, 실제 프랑스인의 입에서 나오는 '우리'는 대부분 **on**이에요. On va au café ?(우리 카페 갈래?)처럼요.\n\n" +
          "on의 정체는 '사람들, 누군가'를 뜻하는 대명사인데, 구어에서 nous를 거의 대체했어요. 문법적으로는 **3인칭 단수** 취급이라 동사가 il/elle과 같은 형태예요 — nous sommes보다 활용이 쉬워서 학습자에게도 이득이죠.\n\n" +
