    ...
    sections: [
      {
        heading: "개념 — 과거의 과거",
        body:
          "복합과거와 반과거로 과거 이야기를 할 수 있게 됐죠. 그런데 이야기를 하다 보면 **그 과거 시점보다 더 먼저 일어난 일**을 말해야 할 때가 있어요.\n\n" +
          "'역에 도착했어요(과거). 그런데 기차는 이미 떠났던 거예요(그보다 먼저).' — 이 '이미 ~했던'을 담당하는 시제가 **대과거(plus-que-parfait)**예요.\n\n" +
          "이제 과거 시간축이 3단이 됐어요: **대과거(더 먼저) → 복합과거(사건)/반과거(배경) → 현재**.",
        examples: [
      ...
      },
      {
        ...
        body:
          "복합과거를 알면 공짜로 얻는 시제예요. 복합과거의 조동사(avoir/être 현재형)를 **반과거형으로 바꾸기만** 하면 돼요.\n\n" +
          "J'ai fini → J'**avais** fini. Je suis parti → J'**étais** parti.\n\n" +
          "조동사 선택(avoir vs être), être일 때의 성·수 일치, 대명동사의 처리 — 전부 복합과거의 규칙이 그대로 적용돼요.",
        table: {
          caption: "대과거 만들기",
          headers: ["복합과거", "대과거", "뜻"],
          rows: [
      ...
      },
      {
        ...
        body:
          "실제 이야기에서는 세 시제가 분업해요. **반과거**가 무대(배경·상태)를 깔고, **복합과거**가 사건을 진행시키고, **대과거**가 그 이전의 사연을 끼워 넣어요.\n\n" +
          "'어제 카페에서 마리를 만났어(복합과거). 그녀는 행복해 보였어(반과거 — 상태). 막 새 직장을 구했던 거야(대과거 — 그 이전의 사연).' — 이 리듬이 프랑스어 스토리텔링의 기본 박자예요.",
        examples: [
...

  {
    ...
    sections: [
      ...
      },
      {
        ...
        body:
          "여기서 중요한 반전. 형태를 배워놓고 하는 말이지만, **프랑스어 회화는 수동태를 별로 좋아하지 않아요**. 행위자가 불분명하거나 중요하지 않으면 수동태 대신 **on**(사람들이/누군가)을 주어로 한 능동문을 쓰는 게 훨씬 자연스러워요.\n\n" +
          "'프랑스에서는 프랑스어가 말해진다'(X) → **On parle français en France**(O). '제 지갑을 도둑맞았어요' → **On m'a volé mon portefeuille**.\n\n" +
          "또 하나의 회피 장치는 **대명동사 수동**이에요: Ça **se vend** bien(그거 잘 팔려요), Le vin blanc **se boit** frais(화이트와인은 차게 마셔요). 일반적 사실·관습을 말할 때 애용돼요.",
        examples: [
      ...
      },
      {
        ...
        body:
          "다행히 한국어에도 피동이 있어서 개념 자체는 익숙해요. 대응을 정리하면: '-되다'(건설되다, 번역되다) ≈ être + p.p., '-받다'(사랑받다, 초대받다) ≈ être + p.p. + de/par, '-당하다'(도둑맞다, 거절당하다) ≈ 수동 또는 on 구문.\n\n" +
          "다만 방향이 항상 일치하지는 않아요. 한국어가 피동으로 말하는 것을 프랑스어는 on 능동으로(도둑맞았다 → On m'a volé...), 반대로 프랑스어가 수동으로 쓰는 것을 한국어는 능동으로 옮기는 게 자연스러울 때가 많아요. **형태 대응이 아니라 '그 상황에서 프랑스인이 뭐라고 하는가'**를 기준으로 삼으세요.",
        examples: [
