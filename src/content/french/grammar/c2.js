...
export default [
  {
    ...
    sections: [
      ...
      },
      {
        heading: "고전 읽기 실전 전략",
        body:
          "이 챕터의 내용을 독서 전략으로 압축하면 세 줄이에요.\n\n" +
          "**1. 모자 쓴 짧은 동사(fût, eût, vînt, pût)가 보이면** 접속법 반과거·대과거 — 의미는 현대어 접속법과 같으니 겁먹지 말 것.\n\n" +
          "**2. -ât, -ît, -ût로 끝나는 동사**도 전부 같은 식구 — 어간만 떼어 원형을 복원할 것.\n\n" +
          "**3. que 없는 자리의 eût/fût + 과거분사**는 '~했을 텐데/~였으리라'로 번역할 것.\n\n" +
          "이 세 규칙이면 발자크와 프루스트의 시제 앞에서 길을 잃지 않아요. 활용표 전체를 외우는 건 프랑스인들도 안 하는 일이니, 우리는 더더욱 할 필요 없어요.",
        examples: [
    ...
    sections: [
      {
        ...
        body:
          "프랑스 수사학의 간판은 **litote**(완서법)예요. 부정이나 절제된 표현으로 **실제보다 약하게 말해서, 오히려 강한 뜻을 전하는** 기법이죠.\n\n" +
          "교과서적 예가 코르네유의 비극 《르 시드》의 한 줄, **«Va, je ne te hais point.»**(가세요, 당신을 미워하지 않아요). 주인공 시멘이 사랑하는 로드리그에게 하는 말인데, '미워하지 않는다'는 절제 아래 '여전히 사랑한다'가 타오르고 있어요. 직접 말할 수 없는 상황이 만든, 프랑스 문학에서 가장 유명한 사랑 고백이에요.\n\n" +
          "litote는 문학만의 것이 아니에요. 일상 프랑스어의 **C'est pas mal**(나쁘지 않네 → 꽤 좋다), **Ce n'est pas faux**(틀린 말은 아니다 → 맞는 말이다)도 같은 원리죠. 프랑스인의 칭찬이 인색해 보이는 건 문화적으로 litote가 기본값이기 때문이기도 해요.",
        examples: [
      ...
      },
      {
        ...
        body:
          "**rythme ternaire**(삼항 리듬) — 프랑스 수사학은 셋을 사랑해요. **Liberté, Égalité, Fraternité**(자유, 평등, 박애)가 원형이죠. 연설, 사설, 광고까지 '명사 셋, 형용사 셋, 절 셋'의 리듬이 기본 박자예요. 드골의 연설도, 대통령 신년사도 이 박자로 흘러가요.\n\n" +
          "**anaphore**(수구 반복) — 문장 첫머리를 반복해 파도를 만드는 기법. 2012년 올랑드 대통령 후보의 토론 «Moi président de la République, je...»를 15번 반복한 연설이 현대의 교과서적 사례예요.\n\n" +
          "**antiphrase**(반어) — 뜻과 반대로 말하기. C'est malin !(참 영리하기도 하지! → 멍청한 짓이야!), Bravo, c'est réussi !(브라보, 아주 성공적이야! → 다 망쳤네). 프랑스식 비꼼(ironie)의 기본 연장이라, 억양과 맥락을 못 읽으면 칭찬으로 오해해요.",
        examples: [
    ...
    sections: [
      {
        ...
        body:
          "프랑스어 화자 약 3억 명 중 프랑스 본토 인구는 일부에 불과해요. 벨기에, 스위스, 캐나다 퀘벡, 그리고 **세네갈·코트디부아르·콩고민주공화국 등 아프리카 20여 개국** — 사실 오늘날 프랑스어 화자의 다수는 아프리카에 있고, 그 비중은 계속 커지고 있어요.\n\n" +
          "C2 수준이라면 파리 표준어만으로는 부족해요. 퀘벡 영화의 대사, 벨기에 동료의 숫자 세기, 아프리카 문학의 어휘에서 변이형을 만나게 되거든요. 다행히 **문어는 거의 통일**되어 있어서, 차이는 주로 발음·어휘·일부 표현에 집중돼요.\n\n" +
          "이 챕터에서는 '다른 게 아니라 틀린 것'이라는 함정을 피하는 게 목표예요. septante는 사투리가 아니라 벨기에·스위스의 **표준**이에요.",
        examples: [
