...

  {
    ...
    sections: [
      ...
      },
      {
        ...
        body:
          "발음 규칙에서 시작해 관사와 성(性), 시제의 숲과 접속법의 안개를 지나 수사학과 번역의 문턱까지 — 프랑스어라는 언어의 지도를 한 바퀴 도셨어요.\n\n" +
          "C2는 끝이 아니라 **자율의 시작**이에요. 이제 문법책이 아니라 작품이 선생님이에요. 라퐁텐을 읽고, 퀘벡 영화를 보고, 마음에 드는 문장을 한국어로 옮겨보세요 — 옮기다 막히는 지점이 다음에 배울 것의 좌표예요.\n\n" +
          "영어라는 자산으로 출발했지만 이제는 **프랑스어 자체가 자산**이에요. 언어를 하나 건넌 사람은 모든 언어 앞에서 용감해집니다. Bonne continuation, et bonne route !",
        examples: [
