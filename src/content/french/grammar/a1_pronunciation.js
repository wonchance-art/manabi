...
const chapters = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        body:
          "**의무 리에종**이 일어나는 환경은 비교적 명확해요. 대부분 **문법적으로 밀착된 단위**(한정사·수사·대명사가 명사/형용사를 수식)에서 발생합니다.\n\n" +
...

  {
    ...
    sections: [
      ...
      },
      {
        ...
        body:
          "프랑스어에서 **리듬 그룹**은 음향학적으로 정의되는 개념이에요. 보통 호흡을 끊지 않고 일관된 속도와 음조로 읽을 수 있는 단위를 말합니다.\n\n" +
      ...
      },
      {
        ...
        body:
          "프랑스어의 가장 눈에 띄는 특징 중 하나는 **음절 등길이**예요. 영어처럼 강한 음절과 약한 음절의 길이 차이가 거의 없습니다.\n\n" +
      ...
      },
      {
        ...
        body:
          ...
          "이 음높이 변화는 언어마다 다른데, 프랑스어를 자연스럽게 발음하려면 이 패턴을 몸에 들여야 합니다.",
        examples: [
          {
            fr: "Je suis coréen.",
            ipa: "[ʒə sɥi kɔʁeɛ̃↓]",
      ...
      },
      {
        ...
        body:
          "리듬과 강세는 문법 규칙이 아니라 **음성 습관**이에요. 이해했다고 바로 말해지지 않으므로, 반복 연습이 필수입니다.\n\n" +
          "**연습법**:\n" +
