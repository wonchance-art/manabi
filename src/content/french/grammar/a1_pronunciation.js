...
const chapters = [
  {
    ...
    summary:
      "잠자던 묵음 끝 자음이 모음 앞에서 살아나 다음 단어와 이어진다 — 한국어 '옷이→오시'와 같은 소리 잇기, 리에종이에요. " +
    ...
    sections: [
      {
        ...
        body:
          "A0 자음 챕터에서 배운 **묵음** 기억하죠? 그 잠자던 끝 자음이 **다음 단어가 모음으로 시작하면 살아나 이어 발음**되는 게 리에종이에요 — '옷이'를 '오시'로 읽는 한국어 연음과 같은 원리라 우리에게 유리해요. 이 챕터가 리에종 규칙의 정본입니다.\n\n" +
      ...
      },
      {
        ...
        pitfall:
          "ils ont [ilzɔ̃](그들은 가진다)과 ils sont [ilsɔ̃](그들은 ~이다)은 리에종의 [z]와 원래 [s]의 차이로만 구별돼요. " +
          "듣기에서 정말 자주 나오는 함정이니 귀를 [z]/[s]에 민감하게 만들어두세요.",
      },
      {
        heading: "형제 현상 — 앙셴느망(이어 읽기)",
        pattern: "발음되는 끝 자음 + 모음 → 한 덩어리 (il est = [i-lɛ] 일레)",
        patternKo: "원래 소리 나던 끝 자음도 다음 모음에 붙여 물 흐르듯",
        body:
          "리에종의 형제로 **앙셴느망(enchaînement)**이 있어요 — 원래부터 발음되던 끝 자음이 다음 모음 단어에 자연스럽게 붙는 현상이에요. 묵음이 되살아나는 리에종과 달리 새 소리가 생기지는 않으니, 굳이 구별해 외울 필요는 없어요.\n\n" +
        ...
        examples: [
          ...
          },
          {
            ...
            ipa: "[ɛlabit]",
            ko: "그녀는 산다",
            note: "h는 묵음이니 l이 바로 a에 붙어요",
          },
        ],
        vsEn:
          "영어에도 연결 발음은 있어요 — an apple을 '어내플'처럼 잇죠. 다만 영어는 '편해서 잇는' 수준이고, " +
          "프랑스어 리에종은 '안 하면 틀리는' 의무 규칙이 따로 있다는 게 차이예요.",
      },
    ],
  },
