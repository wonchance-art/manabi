...
const registry = createRegistry(
  FR_LEVEL_META,
  { A0: grammarA0, A1: [...grammarA1, ...grammarA1Expansion, ...grammarSceneEmergency, ...grammarSceneTravel.filter(ch => ch.level === 'A1')], A2: grammarA2, B1: grammarB1, B2: grammarB2, C1: grammarC1, C2: grammarC2 },
  {
    A0: vocabA0,
