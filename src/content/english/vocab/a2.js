      ...
      words: [
        {
          ...
          ex: { en: "I want to travel to Europe.", ko: "유럽으로 여행 가고 싶어요." },
        },
        {
          en: "trip", ipa: "[trɪp]", ko: "(한 번의) 여행", pos: "n.",
          etym: "'여행 가다'는 go on a trip — travel은 동사로, trip은 명사로 쓰는 게 자연스러워요.",
          ex: { en: "How was your trip to Busan?", ko: "부산 여행 어땠어요?" },
        },
        {
          en: "airport", ipa: "[ˈerpɔːrt]", ko: "공항", pos: "n.",
          etym: "air+port — 라틴어 portus(항구)가 뿌리예요. passport, transport도 형제 단어죠.",
          ex: { en: "The bus to the airport leaves at five.", ko: "공항 가는 버스는 다섯 시에 출발해요." },
        },
        {
          en: "station", ipa: "[ˈsteɪʃn]", ko: "역, 정거장", pos: "n.",
          ex: { en: "Where is the subway station?", ko: "지하철역이 어디예요?" },
        },
        {
          en: "ticket", ipa: "[ˈtɪkɪt]", ko: "표, 승차권", pos: "n.",
          ex: { en: "I bought two tickets for the movie.", ko: "영화표 두 장을 샀어요." },
        },
        { en: "map", ipa: "[mæp]", ko: "지도", pos: "n." },
        { en: "street", ipa: "[striːt]", ko: "거리, 길", pos: "n." },
        {
          en: "left", ipa: "[left]", ko: "왼쪽(의)", pos: "n.",
          ex: { en: "The bank is on your left.", ko: "은행은 왼쪽에 있어요." },
        },
        {
          en: "right", ipa: "[raɪt]", ko: "오른쪽(의); 옳은", pos: "n.",
          ex: { en: "Turn right at the corner.", ko: "모퉁이에서 오른쪽으로 도세요." },
        },
        {
          en: "straight", ipa: "[streɪt]", ko: "곧장, 똑바로", pos: "adv.",
          ex: { en: "Go straight for two blocks.", ko: "두 블록 직진하세요." },
        },
        {
          en: "turn", ipa: "[tɜːrn]", ko: "돌다, 방향을 바꾸다", pos: "v.",
          ex: { en: "Turn left at the next street.", ko: "다음 길에서 왼쪽으로 도세요." },
        },
        {
          en: "arrive", ipa: "[əˈraɪv]", ko: "도착하다", pos: "v.",
          etym: "라틴어 ad ripam(강기슭에 닿다) — '배가 물가에 닿다'에서 온 말이에요.",
          ex: { en: "The train arrives at nine.", ko: "기차는 아홉 시에 도착해요." },
        },
        {
          en: "lost", ipa: "[lɔːst]", ko: "길을 잃은", pos: "adj.",
          ex: { en: "I'm lost. Can you help me?", ko: "길을 잃었어요. 도와주시겠어요?" },
        },
      ],
    },
    {
      ...
      words: [
        {
          ...
          ex: { en: "Where did you buy that bag?", ko: "그 가방 어디서 샀어요?" },
        },
        {
          en: "sell", ipa: "[sel]", ko: "팔다", pos: "v.",
          ex: { en: "This store sells cheap and good clothes.", ko: "이 가게는 싸고 좋은 옷을 팔아요." },
        },
        {
          en: "pay", ipa: "[peɪ]", ko: "지불하다", pos: "v.",
          ex: { en: "Can I pay by card?", ko: "카드로 계산해도 되나요?" },
        },
        {
          en: "price", ipa: "[praɪs]", ko: "가격", pos: "n.",
          ex: { en: "The price is too high for me.", ko: "가격이 저한테는 너무 비싸요." },
        },
        {
          en: "cheap", ipa: "[tʃiːp]", ko: "값싼", pos: "adj.",
          ex: { en: "Street food in Korea is cheap and delicious.", ko: "한국 길거리 음식은 싸고 맛있어요." },
        },
        {
          en: "expensive", ipa: "[ɪkˈspensɪv]", ko: "비싼", pos: "adj.",
          etym: "라틴어 ex+pendere(무게를 달아 지불하다) — spend와 같은 뿌리예요.",
          ex: { en: "This bag is too expensive.", ko: "이 가방은 너무 비싸요." },
        },
        {
          en: "money", ipa: "[ˈmʌni]", ko: "돈", pos: "n.",
          ex: { en: "I am saving money for a trip.", ko: "여행 가려고 돈을 모으고 있어요." },
        },
        {
          en: "cash", ipa: "[kæʃ]", ko: "현금", pos: "n.",
          ex: { en: "Sorry, you can only pay in cash here.", ko: "죄송하지만 여기는 현금만 받아요." },
        },
        { en: "card", ipa: "[kɑːrd]", ko: "카드", pos: "n." },
        {
          en: "size", ipa: "[saɪz]", ko: "크기, 치수", pos: "n.",
          ex: { en: "Do you have a bigger size?", ko: "더 큰 사이즈 있나요?" },
        },
        {
          en: "try on", ipa: "[ˌtraɪ ˈɑːn]", ko: "입어 보다, 신어 보다", pos: "phr.v.",
          ex: { en: "Can I try this on?", ko: "이거 입어 봐도 되나요?" },
        },
        {
          en: "receipt", ipa: "[rɪˈsiːt]", ko: "영수증", pos: "n.",
          etym: "p는 묵음 — 라틴어 recipere(받다)가 뿌리로, receive와 형제예요.",
          ex: { en: "Can I get a receipt, please?", ko: "영수증 좀 주시겠어요?" },
        },
        {
          en: "discount", ipa: "[ˈdɪskaʊnt]", ko: "할인", pos: "n.",
          etym: "할인을 'DC'라고 하면 못 알아들어요 — discount라고 말하세요.",
          ex: { en: "Can I get a discount?", ko: "할인 받을 수 있나요?" },
        },
      ],
    },
    {
      ...
      icon: "💪",
      words: [
        { en: "head", ipa: "[hed]", ko: "머리", pos: "n." },
        { en: "eye", ipa: "[aɪ]", ko: "눈", pos: "n." },
        { en: "ear", ipa: "[ɪr]", ko: "귀", pos: "n." },
        { en: "nose", ipa: "[noʊz]", ko: "코", pos: "n." },
        { en: "mouth", ipa: "[maʊθ]", ko: "입", pos: "n." },
        { en: "hand", ipa: "[hænd]", ko: "손", pos: "n." },
        { en: "leg", ipa: "[leɡ]", ko: "다리", pos: "n." },
        {
          en: "stomach", ipa: "[ˈstʌmək]", ko: "배, 위", pos: "n.",
          etym: "그리스어 stomachos에서 온 말이라 ch가 [k] 소리예요.",
          ex: { en: "My stomach hurts.", ko: "배가 아파요." },
        },
        {
          en: "sick", ipa: "[sɪk]", ko: "아픈, 병이 난", pos: "adj.",
          ex: { en: "I was sick yesterday.", ko: "어제 아팠어요." },
        },
        {
          en: "hurt", ipa: "[hɜːrt]", ko: "아프다, 다치게 하다", pos: "v.",
          ex: { en: "Does it hurt when I press here?", ko: "여기 누르면 아파요?" },
        },
        {
          en: "fever", ipa: "[ˈfiːvər]", ko: "열", pos: "n.",
          ex: { en: "I have a fever.", ko: "열이 나요." },
        },
        {
          en: "medicine", ipa: "[ˈmedsn]", ko: "약", pos: "n.",
          etym: "라틴어 medicus(의사) — medical과 같은 뿌리. '약을 먹다'는 take medicine이에요 (eat 아님!).",
          ex: { en: "Take this medicine three times a day.", ko: "이 약을 하루에 세 번 드세요." },
        },
        {
          en: "hospital", ipa: "[ˈhɑːspɪtl]", ko: "병원", pos: "n.",
          etym: "라틴어 hospes(손님) — hotel, hospitality(환대)와 같은 뿌리예요.",
          ex: { en: "My grandmother is in the hospital now.", ko: "할머니가 지금 병원에 계세요." },
        },
      ],
    },
    {
      ...
      words: [
        {
          ...
          ex: { en: "How's the weather today?", ko: "오늘 날씨 어때요?" },
        },
        {
          en: "sunny", ipa: "[ˈsʌni]", ko: "맑은, 화창한", pos: "adj.",
          ex: { en: "It is sunny today. Let's go out.", ko: "오늘 날씨가 맑아요. 나가요." },
        },
        {
          en: "cloudy", ipa: "[ˈklaʊdi]", ko: "흐린", pos: "adj.",
          ex: { en: "It was cloudy all day yesterday.", ko: "어제는 하루 종일 흐렸어요." },
        },
        {
          en: "rain", ipa: "[reɪn]", ko: "비; 비가 오다", pos: "n.",
          ex: { en: "It will rain tomorrow.", ko: "내일 비가 올 거예요." },
        },
        {
          en: "snow", ipa: "[snoʊ]", ko: "눈; 눈이 오다", pos: "n.",
          ex: { en: "It snowed a lot last winter.", ko: "지난겨울에 눈이 많이 왔어요." },
        },
        { en: "wind", ipa: "[wɪnd]", ko: "바람", pos: "n." },
        {
          en: "warm", ipa: "[wɔːrm]", ko: "따뜻한", pos: "adj.",
          ex: { en: "Spring in Korea is warm and beautiful.", ko: "한국의 봄은 따뜻하고 아름다워요." },
        },
        {
          en: "cool", ipa: "[kuːl]", ko: "시원한; 멋진", pos: "adj.",
          ex: { en: "It is nice and cool in October.", ko: "10월에는 기분 좋게 시원해요." },
        },
        { en: "spring", ipa: "[sprɪŋ]", ko: "봄", pos: "n." },
        {
          en: "summer", ipa: "[ˈsʌmər]", ko: "여름", pos: "n.",
          ex: { en: "It's very hot in summer.", ko: "여름에는 무척 더워요." },
        },
        {
          en: "fall", ipa: "[fɔːl]", ko: "가을", pos: "n.",
          etym: "'잎이 떨어지는(fall) 계절'이라는 미국식 표현 — 영국에서는 autumn이라고 해요.",
          ex: { en: "The mountains are so beautiful in fall.", ko: "가을에는 산이 정말 아름다워요." },
        },
        {
          en: "winter", ipa: "[ˈwɪntər]", ko: "겨울", pos: "n.",
          ex: { en: "Winter in Korea is very cold and long.", ko: "한국의 겨울은 무척 춥고 길어요." },
        },
        {
          en: "umbrella", ipa: "[ʌmˈbrelə]", ko: "우산", pos: "n.",
          etym: "라틴어 umbra(그늘) — 원래는 '햇빛 가리개'였어요.",
          ex: { en: "Take your umbrella with you.", ko: "우산 챙겨 가세요." },
        },
      ],
    },
    {
      ...
      words: [
        {
          en: "wake up", ipa: "[ˌweɪk ˈʌp]", ko: "잠에서 깨다", pos: "phr.v.",
          ex: { en: "I wake up at seven every day.", ko: "저는 매일 일곱 시에 일어나요." },
        },
        {
          en: "get up", ipa: "[ˌɡet ˈʌp]", ko: "(잠자리에서) 일어나다", pos: "phr.v.",
          ex: { en: "I got up late this morning.", ko: "오늘 아침에 늦게 일어났어요." },
        },
        {
          en: "wash", ipa: "[wɑːʃ]", ko: "씻다", pos: "v.",
          ex: { en: "Wash your hands before you eat.", ko: "먹기 전에 손을 씻으세요." },
        },
        {
          en: "wear", ipa: "[wer]", ko: "입고 있다, 착용하다", pos: "v.",
          ex: { en: "She wears glasses.", ko: "그녀는 안경을 써요." },
        },
        {
          en: "cook", ipa: "[kʊk]", ko: "요리하다", pos: "v.",
          ex: { en: "My father cooks dinner on Sundays.", ko: "아버지는 일요일마다 저녁을 만드세요." },
        },
        {
          en: "clean", ipa: "[kliːn]", ko: "청소하다", pos: "v.",
          ex: { en: "I clean my room every Saturday.", ko: "저는 토요일마다 방을 청소해요." },
        },
        {
          en: "drive", ipa: "[draɪv]", ko: "운전하다", pos: "v.",
          ex: { en: "My father drives me to school.", ko: "아빠가 차로 학교에 데려다주세요." },
        },
        {
          en: "ride", ipa: "[raɪd]", ko: "(자전거·말 등을) 타다", pos: "v.",
          ex: { en: "I ride my bike to work.", ko: "저는 자전거를 타고 출근해요." },
        },
        {
          en: "send", ipa: "[send]", ko: "보내다", pos: "v.",
          ex: { en: "I'll send you a text.", ko: "문자 보낼게요." },
        },
        {
          en: "call", ipa: "[kɔːl]", ko: "전화하다, 부르다", pos: "v.",
          ex: { en: "Call me when you arrive home.", ko: "집에 도착하면 전화해요." },
        },
        {
          en: "visit", ipa: "[ˈvɪzɪt]", ko: "방문하다", pos: "v.",
          ex: { en: "We visited my grandmother in Daegu last week.", ko: "지난주에 대구에 계신 할머니를 뵈러 갔어요." },
        },
        {
          en: "finish", ipa: "[ˈfɪnɪʃ]", ko: "끝내다", pos: "v.",
          etym: "라틴어 finis(끝) — final, infinite(끝이 없는)와 같은 뿌리예요.",
          ex: { en: "I finished my homework before dinner.", ko: "저녁 먹기 전에 숙제를 끝냈어요." },
        },
        {
          en: "forget", ipa: "[fərˈɡet]", ko: "잊다", pos: "v.",
          ex: { en: "Don't forget your keys.", ko: "열쇠 잊지 마세요." },
        },
      ],
    },
    {
      ...
      words: [
        {
          en: "glad", ipa: "[ɡlæd]", ko: "기쁜, 반가운", pos: "adj.",
          ex: { en: "I'm glad you came.", ko: "와 줘서 기뻐요." },
        },
        {
          en: "excited", ipa: "[ɪkˈsaɪtɪd]", ko: "신난, 들뜬", pos: "adj.",
          etym: "내가 신나면 excited, 나를 신나게 하는 것은 exciting — -ed/-ing 혼동 주의!",
          ex: { en: "I'm so excited about the trip.", ko: "여행 갈 생각에 너무 설레요." },
        },
        {
          en: "nervous", ipa: "[ˈnɜːrvəs]", ko: "긴장한, 불안한", pos: "adj.",
          etym: "라틴어 nervus(신경) — nerve(신경)와 같은 뿌리예요.",
          ex: { en: "I was nervous before the interview.", ko: "면접 전에 긴장했어요." },
        },
        {
          en: "worried", ipa: "[ˈwɜːrid]", ko: "걱정하는", pos: "adj.",
          ex: { en: "I'm worried about the test.", ko: "시험이 걱정돼요." },
        },
        {
          en: "angry", ipa: "[ˈæŋɡri]", ko: "화난", pos: "adj.",
          ex: { en: "Why are you angry with me?", ko: "왜 저한테 화났어요?" },
        },
        {
          en: "scared", ipa: "[skerd]", ko: "무서워하는, 겁먹은", pos: "adj.",
          ex: { en: "My little sister is scared of dogs.", ko: "제 여동생은 개를 무서워해요." },
        },
        {
          en: "bored", ipa: "[bɔːrd]", ko: "지루해하는", pos: "adj.",
          etym: "I'm boring이라고 하면 '나는 지루한 사람'이라는 뜻이 돼요 — 내가 심심하면 bored!",
          ex: { en: "I'm bored. Let's go out.", ko: "심심해요. 나가요." },
        },
        {
          en: "surprised", ipa: "[sərˈpraɪzd]", ko: "놀란", pos: "adj.",
          ex: { en: "I was surprised to see you here.", ko: "여기서 보다니 놀랐어요." },
        },
        {
          en: "proud", ipa: "[praʊd]", ko: "자랑스러워하는", pos: "adj.",
          ex: { en: "I'm proud of you.", ko: "네가 자랑스러워." },
        },
        {
          en: "lonely", ipa: "[ˈloʊnli]", ko: "외로운", pos: "adj.",
          ex: { en: "She felt lonely in the new city.", ko: "그녀는 새 도시에서 외로움을 느꼈어요." },
        },
        {
          en: "upset", ipa: "[ʌpˈset]", ko: "속상한, 마음 상한", pos: "adj.",
          ex: { en: "He was upset about the bad news.", ko: "그는 나쁜 소식에 속상해했어요." },
        },
        {
          en: "shy", ipa: "[ʃaɪ]", ko: "수줍은", pos: "adj.",
          ex: { en: "Don't be shy. Say hello to them.", ko: "수줍어하지 말고 인사해 봐요." },
        },
        {
          en: "jealous", ipa: "[ˈdʒeləs]", ko: "질투하는, 부러워하는", pos: "adj.",
          ex: { en: "I am jealous of your long vacation.", ko: "긴 휴가라니 부러워요." },
        },
      ],
    },
    {
      ...
      words: [
        {
          en: "cell phone", ipa: "[ˈsel foʊn]", ko: "휴대폰", pos: "n.",
          etym: "'핸드폰(hand phone)'은 콩글리시 — cell phone 또는 mobile phone이라고 해요.",
          ex: { en: "I left my cell phone at home.", ko: "휴대폰을 집에 두고 왔어요." },
        },
        {
          en: "window shopping", ipa: "[ˈwɪndoʊ ˌʃɑːpɪŋ]", ko: "구경만 하는 쇼핑", pos: "n.",
          etym: "'아이쇼핑(eye shopping)'은 영어에 없어요 — window shopping이 맞아요.",
          ex: { en: "We went window shopping at the mall.", ko: "우리는 쇼핑몰에서 아이쇼핑을 했어요." },
        },
        {
          en: "laptop", ipa: "[ˈlæptɑːp]", ko: "노트북 컴퓨터", pos: "n.",
          etym: "'노트북'은 영어로 laptop(무릎 위에 놓는 것) — notebook은 종이 공책이에요.",
          ex: { en: "I bought a new laptop for work.", ko: "업무용으로 새 노트북을 샀어요." },
        },
        {
          en: "air conditioner", ipa: "[ˈer kənˌdɪʃənər]", ko: "에어컨", pos: "n.",
          etym: "'에어컨'은 air conditioner의 줄임 — 영어로 줄일 때는 AC라고 해요.",
          ex: { en: "Can you turn on the air conditioner?", ko: "에어컨 좀 켜 줄래요?" },
        },
        {
          en: "dress", ipa: "[dres]", ko: "원피스", pos: "n.",
          etym: "'원피스(one-piece)'는 콩글리시 — 영어로는 그냥 dress예요.",
          ex: { en: "She wore a yellow dress to the party.", ko: "그녀는 파티에 노란 원피스를 입고 갔어요." },
        },
        {
          en: "gym", ipa: "[dʒɪm]", ko: "헬스장", pos: "n.",
          etym: "'헬스 가다'는 go to the gym — health는 '건강'이라는 명사일 뿐이에요.",
          ex: { en: "I go to the gym twice a week.", ko: "저는 일주일에 두 번 헬스장에 가요." },
        },
        {
          en: "selfie", ipa: "[ˈselfi]", ko: "셀카", pos: "n.",
          etym: "'셀카(self camera)'는 콩글리시 — selfie가 맞아요.",
          ex: { en: "Let's take a selfie!", ko: "셀카 찍어요!" },
        },
        {
          en: "soda", ipa: "[ˈsoʊdə]", ko: "탄산음료", pos: "n.",
          etym: "'사이다'를 주문하면 사과 발효주(cider)가 나올 수 있어요 — 스프라이트류는 soda 또는 lemon-lime soda예요.",
          ex: { en: "I will have a soda with my pizza.", ko: "피자랑 탄산음료 마실게요." },
        },
        {
          en: "corn dog", ipa: "[ˈkɔːrn dɔːɡ]", ko: "(막대에 꽂은) 핫도그", pos: "n.",
          etym: "한국식 '핫도그'는 corn dog — hot dog는 빵 사이에 소시지를 끼운 것이에요.",
          ex: { en: "Corn dogs are popular street food in Korea.", ko: "핫도그는 한국에서 인기 있는 길거리 음식이에요." },
        },
        {
          en: "cheating", ipa: "[ˈtʃiːtɪŋ]", ko: "(시험) 부정행위", pos: "n.",
          etym: "시험 '커닝(cunning)'은 콩글리시 — cheating이 맞아요. cunning은 '교활한'이라는 형용사예요.",
          ex: { en: "Cheating on a test is a serious problem.", ko: "시험 부정행위는 심각한 문제예요." },
        },
        {
          en: "office worker", ipa: "[ˈɔːfɪs ˌwɜːrkər]", ko: "회사원", pos: "n.",
          etym: "'샐러리맨'은 일본식 영어 — office worker라고 해요.",
          ex: { en: "My brother is an office worker.", ko: "우리 형은 회사원이에요." },
        },
        {
