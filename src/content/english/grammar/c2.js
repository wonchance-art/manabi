    ...
    sections: [
      {
        ...
        body:
          ...
          "C2에서 수사를 배우는 이유는 연설가가 되기 위해서가 아니라 **수신 감도**를 올리기 위해서예요. 사설, TED 강연, 광고 카피 — 영어 담화의 고급 영역은 전부 수사 장치로 직조되어 있어서, 장치가 보여야 글쓴이의 의도와 솜씨가 보여요.\n\n" +
      ...
      },
      {
        ...
        tip: "실전 영어 발표에서 가장 가성비 좋은 수사가 삼항이에요. 형용사든 명사구든 절이든, 핵심 메시지를 셋으로 묶고 가장 강한 것을 마지막에 놓으세요. 둘밖에 없으면 하나를 쪼개서라도 셋을 만드는 게 연설문 작가들의 공공연한 비밀이에요.",
      },
      {
        ...
        vsKo: "한국어 수사는 첫소리보다 **어미와 통사 구조의 반복**(대구, '-느냐'의 반복 등)으로 리듬을 만들어요. '소리 맞추기'가 격조가 된다는 감각 자체가 낯설죠. 그래서 한국 학습자는 두운을 '우연'으로 흘려듣기 쉬워요 — 영어 연설에서 같은 첫소리가 세 번 이상 들리면 우연이 아니라 설계라고 보시면 돼요.",
      },
      {
        ...
        body:
          ...
          "수신 주의보 — 영국인의 not too bad는 '꽤 좋다', a bit disappointing은 '심각하게 나쁘다'일 수 있어요. 절제 표현 문화권에서는 **말의 액면가에서 한두 단계 올려 들어야** 해요.",
        examples: [
      ...
      },
      {
        ...
        body:
          ...
          "공통 원리는 **평행 구조(parallelism)** — 같은 문법 틀을 반복하면 내용의 차이가 도드라져요. 이력서 불릿을 모두 동사원형으로 시작하는 것도 평행 구조의 실무 응용이에요.",
        examples: [
    ...
    sections: [
      {
        ...
        tip: "한국 영어 교육은 사실상 미국 영어 기반이에요(발음 기호, 교과서, 시험). 그게 여러분의 기본값이라는 걸 인지하고 있으면, 영국 드라마나 호주 동료의 영어가 '틀린' 게 아니라 '다른' 것으로 들리기 시작해요.",
      },
      {
      ...
      },
      {
        ...
        etym: "'미국 영어가 영어를 망쳤다'는 통념은 역사적으로 부정확해요. gotten, fall(가을), I guess(~인 것 같아)는 모두 17세기 영국 이주민이 가져간 **당시의 표준 영어**예요. 영국 본토가 변하는 동안 식민지가 옛 형태를 보존한 거죠 — 언어학에서 말하는 '주변부의 보수성'이에요. 제주 방언에 중세 한국어 흔적이 남은 것과 같은 원리예요.",
      },
      {
        ...
        body:
          ...
          "가장 중요한 현실은 **lingua franca로서의 영어(ELF)** — 오늘날 영어 대화의 다수파는 비모어 화자끼리예요. 이 환경에서 통하는 조건은 원어민스러운 관용구가 아니라 **명료성**이에요. 역설적이게도 ELF 환경에서는 관용구 범벅의 원어민이 가장 알아듣기 어려운 화자가 되곤 해요.",
        examples: [
        ...
        vsKo: "한국어에도 변이는 있지만(서울/경상/제주), 표준어의 구심력이 압도적이라 '복수 표준'이라는 개념이 낯설어요. 영어에는 **표준이 여러 개**예요 — 영국 BBC 영어와 미국 네트워크 영어는 동급의 표준이고, 어느 쪽도 상대를 교정할 권위가 없어요. '원어민처럼'이라는 목표 자체가 '어느 원어민?'이라는 반문 앞에서 흔들리는 이유이고, 그래서 C2의 목표는 모사가 아니라 **명료하고 일관된 자기 영어**예요.",
      },
    ],
  },
    ...
    sections: [
      {
        ...
        body:
          ...
          "한국어로 비유하면 '사면초가', '계륵' 같은 고사성어의 자리예요. 학습 전략도 같아요 — **표현과 배경 이야기를 세트로** 외우면 잊히지 않아요.",
        examples: [
        ...
        vsKo: "한국어 담화의 공유 메모리가 한문 고전 + 한국사(이순신, 세종)에서 온다면, 영어는 그리스 신화 + 성경 + 셰익스피어예요. 흥미로운 건 기능이 똑같다는 것 — '트로이 목마'와 '사면초가'는 둘 다 '고전 군사 고사에서 온 압축 표현'이죠. 여러분이 고사성어를 다루는 그 감각을 그대로 가져오면 돼요.",
      },
      {
        ...
        etym: "1611년의 킹 제임스 성경(King James Version)은 셰익스피어와 함께 근대 영어의 두 주형(틀)이에요. by the skin of one's teeth(간신히), a drop in the bucket(새 발의 피), no rest for the wicked — 전부 이 번역본의 문장이 그대로 관용구가 된 경우예요. 영어 관용구의 출처를 찾다 보면 절반은 KJV 아니면 셰익스피어에 닿아요.",
      },
      {
      ...
      },
      {
        ...
        etym: "신화는 어휘의 뿌리이기도 해요. panic은 목신 판(Pan)이 일으키는 공포에서, narcissism은 물에 비친 자신과 사랑에 빠진 나르키소스에서, echo는 목소리만 남은 님프 에코에서 왔어요. tantalize(애태우다)는 눈앞의 물과 과일에 영원히 닿지 못하는 탄탈로스의 형벌이고요. 단어 하나에 이야기 하나 — C2 어휘 암기의 최고급 연료예요.",
      },
      {
        ...
        body:
          ...
          "그 밖에 **Jekyll and Hyde**(이중인격), **Frankenstein('s monster)**(창조자를 삼키는 피조물), **Brave New World**도 헤드라인 단골이에요.",
        examples: [
    ...
    sections: [
      ...
      },
      {
        ...
        body:
          ...
          "문화 코드: 좋은 pun의 표준 반응은 폭소가 아니라 **신음(groan)** — 한심하다는 듯 끙 소리가 사실상 '인정'이에요. dad joke는 한국 아재개그와 **정확히 같은 사회적 위치**고, pun은 **헤드라인·광고의 기본 기술**이라 수신 능력이 곧 실전 독해력이에요.",
        examples: [
        ...
        etym: "한국 아재개그도 같은 원리예요 — '바나나 먹으면 나한테 반하나?'는 소리 충돌, 영어 pun과 완전히 같은 기계장치죠. 다른 점은 원료예요. 한국어 말장난은 음절 단위 유사음에서, 영어 pun은 동음이의어와 다의어에서 나와요. 언어는 달라도 '아빠들이 하고 아이들이 신음하는' 사회적 코드는 신기할 만큼 똑같아요.",
      },
      {
        ...
        tip: "유머 수신력을 올리는 최고의 교재는 시트콤이에요. 미국식은 「The Office(US)」(deadpan + 어색 유머), 「Brooklyn Nine-Nine」(속사포 banter), 영국식은 「The Office(UK)」와 패널 쇼들이 좋아요. 자막으로 한 번, 무자막으로 한 번 — 웃음 트랙이 터지는데 나만 안 웃긴 장면을 수집해서 분해해보세요. 그 간극이 바로 여러분의 다음 학습 목록이에요.",
      },
    ],
  },
    ...
    sections: [
      {
        ...
        etym: "translate는 라틴어 trans(건너로)+latus(운반된), 즉 '건너편으로 옮기기'예요. 5챕터 전에 본 metaphor(meta+pherein, 너머로 나르다)와 완전히 같은 구조죠 — 라틴어와 그리스어로 같은 그림을 그린 단어예요. 번역과 은유는 어원부터 형제예요: 둘 다 의미를 싣고 강을 건너는 일이에요.",
      },
      {
      ...
      },
      {
        ...
        tip: "자기 번역투를 진단하는 테스트: 최근에 쓴 한국어 글에서 '~의 ~'가 연쇄된 문장과 무생물 주어 + '~을 초래했다/야기했다'를 찾아보세요. 영어 글에서는 반대로, 모든 문장의 주어가 I나 사람인지 보세요. 양쪽 다 발견된다면 — 축하해요, 두 언어의 중간 지대에 살고 있다는 증거예요. 의식적인 방향 전환 연습만 더하면 돼요.",
      },
      {
        ...
        tip: "졸업 과제를 하나 드릴게요. 좋아하는 한국어 문장 하나(시 한 줄, 가사 한 소절)를 영어로 옮겨보고, 무엇을 지키고 무엇을 포기했는지 적어보세요. 그 메모가 곧 여러분의 번역론이고, 이 레퍼런스 전체의 살아 있는 복습이에요. 수고하셨어요 — 아, 이 인사부터 번역 협상이 필요하겠네요. Great work, and see you between the languages.",
      },
    ],
  },
];
