...
export default [
...

  {
    ...
    level: "A1",
    order: 2,
    title: "일반동사 현재와 3인칭 -s — 최장수 실수를 미리 잡기",
...

  {
    ...
    level: "A1",
    order: 5,
    title: "대명사와 소유격 — he/she가 자꾸 꼬이는 이유",
...

  {
    ...
    level: "A1",
    order: 7,
    title: "do 의문문과 부정문 — 한국어에 없는 도우미 동사",
...

  {
    ...
    level: "A1",
    order: 8,
    title: "전치사 in/on/at — '에' 하나가 셋으로 갈라진다",
