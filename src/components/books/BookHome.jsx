...
export default function BookHome({ book, preview=false, progress, hasProgress = false, ready = true }) {
  ...
  return <div className="manabi-page manabi-book-home"><p className="manabi-breadcrumb"><LibraryReturnLink/><Link href="/lessons">교재</Link><span>/</span>일본어 · N5</p>
