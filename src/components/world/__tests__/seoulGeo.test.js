...
describe('서울 실지형 데이터 계약', () => {
  ...
  it('모든 보행 타일과 POI·역이 서울역 기준 단일 4방 BFS 성분이다', () => {
    ...
    expect(walkable).toBe(1_622_896);
...
describe('서울 생성 결정성·오프라인 계약', () => {
  ...
  it('두 번 재생성한 결과와 커밋 산출물 해시가 같다', () => {
    ...
    expect(terrainHash(first.terrain)).toBe('c1b97f1359ceadf253c8d2da91d02f016f89e1afb4f1bb78e8a2d732a279d29f');
  ...
  it('RLE 왕복이 전체 지형·철도를 보존하고 런타임 산출물은 오프라인이다', () => {
    ...
    expect(terrainRuns).toHaveLength(483_692);
