...
const KYUSHU_SPOTS = [
  ...
  // 佐賀
  { id: 'yoshinogari', name: '요시노가리', tile: [134, 313], desc: '야요이 시대 환호(環濠) 집락 유적을 복원한 사적 공원 「吉野ヶ里歴史公園」(よしのがりれきしこうえん).', refs: ['歴史', '公園'], refsLang: 'ja' },
  { id: 'karatsu-castle', name: '가라쓰성', tile: [126, 310], desc: '가라쓰만을 내려다보는 언덕 위 성 「唐津城」(からつじょう). ‘마이즈루성’이라고도 불려요.', refs: ['城'], refsLang: 'ja' },
  { id: 'yutoku-inari', name: '유토쿠 이나리 신사', tile: [128, 319], desc: '주칠(朱漆) 누각 구조의 이나리 신사 「祐徳稲荷神社」(ゆうとくいなりじんじゃ). 일본 3대 이나리의 하나로 꼽혀요.', refs: ['神社'], refsLang: 'ja' },
  // 長崎
  ...
  // 熊本
  { id: 'kumamoto-castle', name: '구마모토성', tile: [141, 326], desc: '가토 기요마사가 축성한 성 「熊本城」(くまもとじょう). 2016년 지진 피해 후 복구가 진행되고 있어요.', refs: ['城'], refsLang: 'ja' },
  ...
  // 大分
  { id: 'beppu-onsen', name: '벳푸 온천', tile: [156, 314], desc: '색·형태가 다른 원천을 도는 ‘지고쿠메구리(地獄めぐり·지옥순례)’로 알려진 온천지 「別府温泉」(べっぷおんせん).', refs: ['地獄', '温泉'], refsLang: 'ja' },
  ...
  { id: 'aoshima-jinja', name: '아오시마 신사', tile: [155, 351], desc: '파식대(鬼の洗濯板)에 둘러싸인 아오시마 섬에 자리한 신사 「青島神社」(あおしまじんじゃ).', refs: ['洗濯', '神社'], refsLang: 'ja' },
  ...
  { id: 'ibusuki-onsen', name: '이부스키 온천', tile: [139, 365], arrivalOffset: [0, -1], desc: '데워진 모래에 몸을 묻는 ‘스나무시(砂むし·모래찜질)’ 온천으로 알려진 온천지 「指宿温泉」(いぶすきおんせん).', refs: ['温泉'], refsLang: 'ja' },
...
//   요리 자체(郷土料理/名物) 중심·검증본, 확실한 노포만 상호 병기. 단정 회피.
const GOURMET = [
  ...
  { id: 'gourmet-kumamoto', name: '가라시렌콘(熊本)', tile: [138, 324], desc: '연근 구멍에 겨자된장을 채워 튀긴 구마모토 향토요리 「辛子蓮根」(가라시렌콘). 말고기 회 「馬刺し」(바사시), 당면을 넣은 중화풍 스프 「太平燕」(타이피엔)도 구마모토의 명물이에요.' },
...
const HONSHU_SPOTS = [
  { id: 'hiroshima-peace', name: '히로시마 평화기념공원', tile: [175, 287], lon: 132.4536, lat: 34.3955, desc: '원폭 돔 「原爆ドーム」(げんばくドーム)과 자료관을 품고, 핵무기 없는 평화를 전하는 공원 「平和記念公園」(へいわきねんこうえん).', refs: ['原爆', '平和', '記念', '公園'], refsLang: 'ja' },
  ...
  { id: 'himeji-castle', name: '히메지성', tile: [218, 276], lon: 134.6939, lat: 34.8394, desc: '흰 회벽과 보존된 성곽으로 알려진 세계문화유산 「姫路城」(ひめじじょう). 흰 새를 닮아 ‘시라사기성’이라고도 불려요.', refs: ['城'], refsLang: 'ja' },
  ...
  { id: 'hirosaki-castle', name: '히로사키성', tile: [331, 133], lon: 140.467, lat: 40.607, desc: '해자·성문·망루와 에도 시대 천수각이 남은 북쪽 성 「弘前城」(ひろさきじょう). 봄 벚꽃과 겨울 눈 풍경으로 알려져요.', refs: ['城'], refsLang: 'ja' },
].map((s) => ({ ...s, kind: 'landmark' }));
...
const HONSHU_GOURMET = [
  ...
  { id: 'gourmet-nagoya', name: '미소카쓰(名古屋)', tile: [261, 267], lon: 136.9066, lat: 35.1815, desc: '튀긴 돼지고기 커틀릿에 진한 된장 소스를 곁들이는 나고야 음식 「味噌カツ」(みそカツ). ‘나고야메시’로 불리는 지역 요리의 하나예요.', refs: ['味噌'], refsLang: 'ja' },
  { id: 'gourmet-nagano', name: '신슈 소바(長野)', tile: [286, 231], lon: 138.181, lat: 36.648, desc: '메밀이 잘 자라는 나가노의 대표 면 「信州そば」(しんしゅうそば). 차갑거나 따뜻하게 먹고 계절 재료를 곁들이기도 해요.', refs: ['そば'], refsLang: 'ja' },
