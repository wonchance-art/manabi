...
export const NPC_SCRIPTS = {
  ...
  konbini: {
    ...
    steps: [
      { t: 'narr', text: '자동문이 스르륵 — 사방에서 いらっしゃいませ!가 쏟아진다. 대답 대신 가벼운 목례. 삼각김밥과 호빵을 계산대에 올린다.' },
      {
        t: 'say', who: 'npc',
        ja: 'いらっしゃいませ。肉まん、あたためますか。',
        yomi: 'いらっしゃいませ。にくまん、あたためますか (이랏샤이마세. 니쿠만, 아타타메마스카)',
        ko: '어서 오세요. 호빵, 데워 드릴까요?',
  ...
  izakaya: {
    ...
    steps: [
      ...
      { t: 'narr', text: '앉자마자, 주문도 안 했는데 삶은 풋콩 접시가 툭 — "어? 이거 안 시켰는데?"' },
      {
        ...
        ko: '그건 오토시(기본 안주)예요.',
        narr: 'お通し=주문 안 해도 나오는 유료 기본 안주(1인 300~500엔). 자릿세 같은 문화 — 바가지 아님!',
      },
      {
        t: 'ask', mode: 'choice',
        prompt: '점원이 첫 주문을 기다려요. 일본인이 앉자마자 외치는 "국민 첫 주문"은?',
        choices: [
          { ja: 'とりあえず生で。', yomi: 'とりあえずなまで (토리아에즈 나마데)', correct: true },
          { ja: 'おあいそ おねがいします。', yomi: 'おあいそ おねがいします (오아이소 오네가이시마스)' },
          { ja: 'ごちそうさまでした。', yomi: 'ごちそうさまでした (고치소-사마데시타)' },
        ],
        why: 'とりあえず生で=일단 생맥으로. 生는 生ビール(생맥주)의 준말, 끝의 で는 6챕터 수단의 で. 술이 부담이면 ウーロン茶ください로 바꿔도 흐름은 똑같아요.',
      },
      {
        t: 'ask', mode: 'type',
        prompt: '점원이 멀리 있어요. 손 들고 크게 불러요! 「___！」 (이자카야에선 큰 소리로 불러도 무례하지 않아요.)',
        before: '', after: '！',
        answer: 'すみません', accept: ['すみません', 'すいません'],
        hint: '스미마셍 — "여기요/저기요"로 점원 부르기.',
        why: 'すみません!=여기요! 한국에선 조심스럽지만 일본 이자카야에선 크게 부르는 게 정석이에요.',
      },
      {
        t: 'say', who: 'npc',
        ja: 'はい！生 おまちどおさま。',
