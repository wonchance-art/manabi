...
//   · ramen  — 후쿠오카 라멘 포장마차 주인 (챕터 ot-10-ramen 기반: 食券·바리카타·替え玉)
...
export const NPC_SCRIPTS = {
  // ── 후쿠오카 라멘 포장마차 주인 (ot-10-ramen) ──
  ramen: {
    label: '포장마차 주인',
    emoji: '🍜',
    intro: '하카타 돈코츠 라멘 포장마차. 券売機(켄바이키)에서 식권부터!',
    steps: [
      { t: 'narr', text: '포장마차(屋台, 야타이)의 붉은 노렌을 젖히자 뽀얀 김이 확 — 주인아저씨가 씩 웃는다.' },
      {
        t: 'say', who: 'npc',
