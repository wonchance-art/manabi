...
export default function ClassroomReader({context,user,material,selection,wordContent,sentenceContent,fallback,onActive,suppressed}) {
  ...
  return <ClassReaderSession key={`${user.id}:${team.key}:${context.day}`} root={root.data} team={team} day={context.day} material={material} selection={selection} wordContent={wordContent} sentenceContent={sentenceContent} suppressed={suppressed}/>;
}

function ClassReaderSession({root,team,day,material,selection,wordContent,sentenceContent,suppressed}) {
