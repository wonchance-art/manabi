          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
            {[
              ...
              },
              {
                href: '/admin/worldmap',
                icon: '🗺️',
                title: '전체 맵 뷰어 (실험) — 월드 448×384 지도 줌·팬',
              ...
              },
              {
                ...
                desc: 'LingQ식 정독 도구 — 영상 검색 → 자막 트랙 자동 로드 → 재생 위치에 싱크된 스크립트로 정독하며 모르는 표현을 탭해 단어장에 저장. 자막이 없으면 .srt/.vtt·붙여넣기로 폴백. 관리자 실험용 — 네비·학습 탭엔 미노출.',
              },
              {
                href: '/admin/metrics',
                icon: '📊',
