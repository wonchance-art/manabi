...
const PRACTICE = [
  {
    title: '복습',
    desc: '오늘 몫의 단어·문법을 카드로 한 번 더 돌려요.',
    href: '/vocab',
  },
  {
    title: '문법만',
    desc: '지금까지 배운 문법 패턴만 골라 다시 짚어요.',
    href: '/review/grammar',
  },
  {
    title: '작문',
    ...
    <div className="page-container" style={{ maxWidth: '760px' }}>
      ...
      <div className="guide-hero" style={{ marginBottom: 36 }}>
        <h1 className="guide-hero__title">
          하루에 <span className="guide-hero__accent">학습 한 번</span>, 그게 전부예요
        </h1>
        <p className="guide-hero__sub" style={{ textWrap: 'balance' }}>
          복습할 단어·문법과 새로 배울 것이 매일 새 이야기 한 편에 담겨 나와요.
        </p>
      </div>
      ...
      >
        ...
        >
          이야기를 읽고 10문항 안팎을 풀면 6~8분에 하루치가 끝나요.
          격일로 짧은 쓰기도 섞여요. 놓친 날이 있어도 복습 시점은 알아서 다시 잡혀요.
        </p>
      ...
      <section className="card" style={{ padding: 24, marginBottom: 20 }}>
        ...
        <p style={{ fontSize: '0.85rem', color: 'var(--text-muted)', lineHeight: 1.7, marginBottom: 16 }}>
          오늘 학습만으로 충분하지만, 더 돌리고 싶은 날의 문은 이쪽이에요.
        </p>
      ...
      <section className="card" style={{ padding: 24 }}>
        ...
        <ul style={{ listStyle: 'none', margin: 0, padding: 0, display: 'flex', flexDirection: 'column', gap: 10 }}>
          {TIPS.map(tip => (
            ...
            >
              <span style={{ position: 'absolute', left: 0, color: 'var(--accent-text)' }}>·</span>
              {tip}
            </li>
          ))}
        </ul>
