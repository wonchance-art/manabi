...
export default async function Page({searchParams}) {
  ...
  if(params?.view==='reading')return <div className="manabi-page"><header className="manabi-page-heading"><div><Link className="manabi-link" href="/discover">← 발견</Link><h1>함께 읽는 글<span>.</span></h1></div><Link className="manabi-link" href="/materials">내 서재 ↗</Link></header><MaterialsPage libraryView="public"/></div>;
  let book = null;
  ...
  return <div className="manabi-page manabi-discover"><header className="manabi-page-heading"><div><p className="manabi-eyebrow">BEYOND THE LANGUAGE / 발견</p><h1>말이 태어나는 곳<span>.</span></h1></div><Link className="manabi-link" href="/discover?view=reading">외국어 읽을거리 ↗</Link></header>
