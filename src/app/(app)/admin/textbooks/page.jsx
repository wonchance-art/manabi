...
export default async function Page({ searchParams }) {
  ...
  return <><p className="page-container"><Link href="/admin/legacy-textbooks">기존 교재 보관함 ←</Link>　<Link href="/admin/books/japanese-n5">일본어 N5 · 한 권 원고 편집 →</Link></p><TextbookEditor catalog={catalog} initialLang={params?.lang} initialSlug={params?.slug} /></>;
}
