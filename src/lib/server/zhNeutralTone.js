...
const HAND = {
  ...
  // ── 동사·형용사 ──
  // ── 분석기 리뷰 라운드 1 (2026-09-02) — 코퍼스 대조에서 드러난 공백. 那里는 CEDICT 층에
  //    있는데 这里·哪里는 없어 비일관이었다. 早上·晚上·故事는 现汉 필독 경성(zǎo·shang 등).
  //    地方(dì·fang/dìfāng 다의)·这边·起来(방향보어)는 기준 ②·③대로 여전히 배제.
  早上: 'zǎo shang',
  晚上: 'wǎn shang',
  这里: 'zhè li',
  哪里: 'nǎ li',
