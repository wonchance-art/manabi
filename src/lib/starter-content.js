...
私の名前は山田です。`,
  ...
  {
    title: '[N5 문법 #2] ~じゃありません (명사 부정)',
    language: 'Japanese', level: 'N5 기초',
    raw_text: `私は学生じゃありません。会社員です。
これは本じゃありません。ノートです。
彼は中国人じゃありません。日本人です。
今日は休みじゃありません。仕事の日です。
あれは私のかばんじゃありません。
山田さんは先生じゃありません。学生です。`,
  ...
  {
    title: '[N5 문법 #3] これ・それ・あれ (지시 대명사)',
    language: 'Japanese', level: 'N5 기초',
    raw_text: `これは何ですか。それは本です。
これは私のペンです。
それは誰のかばんですか。
あれは新しい車です。
これとそれは違います。
...
学校へ行きます。`,
  ...
  {
    title: '[N5 문법 #11] ~ました・~ませんでした (과거형)',
    language: 'Japanese', level: 'N5 기초',
    raw_text: `昨日、友達と映画を見ました。
朝、コーヒーを飲みました。
宿題をしませんでした。
電車に乗り遅れました。
日曜日は何もしませんでした。
...
昨日は早く寝ました。`,
  ...
  {
    title: '[N5 문법 #12] い-형용사',
    language: 'Japanese', level: 'N5 기초',
    raw_text: `このカレーはおいしいです。
このカレーはおいしくないです。
昨日は楽しかったです。
昨日は楽しくなかったです。
新しい本は高いです。
...
コーヒーが飲みたいです。`,
  ...
  {
    title: '[N5 문법 #15] ~てください (~해 주세요)',
    language: 'Japanese', level: 'N5 기초',
    raw_text: `ゆっくり話してください。
ここに名前を書いてください。
窓を開けてください。
もう一度言ってください。
これを見てください。
