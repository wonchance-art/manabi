...
2026-09-16 KST · 최초 실행 코드 7b5d896619dc902063909c5fa10d54b6ec43629c

후속 Safari 탐색 수정과 최신 배포/검수는 [설명판 Safari 검수](teaching-board-safari-20260916.md)에 기록한다. 아래는 최초 부분 복사 구현의 검수 이력이다.
