...
2026-09-12 후속: 상단 로그인 수업 주소 유실, 학생 사본 검수의 관리자 fixture, Preview 빌드 메모리를 보완했다. 최종8b6f3d7b 배포/CI와 자동37개 검수 완료. 상세 `classroom-student-auth-20260912.md`; 별도 실제 학생 로그인/입장은 아직 미완료다.
