...
### todo
- **개인 노트 사용성 후속 (2026-09-16)** — #1313/#1314는 main d6dbcff7 및 운영 배포 완료, 실제 노트·필기 복원 확인. 여러 영역 누적/중복 방지는 이미 구현됨. 다음은 인식 후 필기를 계속하고 수업 후 검토하는 흐름, 검토/저장 상태 필터와 미완료 이어 하기. 물리 iPad/Pencil·다양한 필체·실기기 동시 수정, 외부 PDF/이미지 반입은 별도.
