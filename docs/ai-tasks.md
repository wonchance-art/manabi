...
## Codex-1 (codex/*)
### doing
- **뷰어 신뢰성 1차 (2026-09-09, 오너 설계 승인·“진행 가자”)** — `codex/viewer-reliability-20260909`, 부모 #1292 `7d7c6a6496243e014c17f9bd66161c34e9033212`. 문맥 뜻·표시/저장 일치, 요청 경합·캐시·undo·숨은 카드 입력, 중국어 읽기/인식 연결, 재분석 성공 후 조건부 교체. SPEC `docs/manabi-viewer-reliability.md`. 원본 공유 폴더/교재/FSRS/권한 보존, merge·force-push·월드·PDF 조판·새 음성 제외. PR #1293 draft: 전체 362파일/3,923테스트·브라우저 16흐름·로컬 SQL 13검사 통과. 코드 검수/개별 미리보기 준비, 운영 함수 2개는 오너 예외 승인 대기. 완료로 이동하지 않음.
