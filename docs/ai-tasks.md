...
## Codex-1 (codex/*)
### doing
- **교재 설명·주의점 실계정 검수 (2026-09-10)** — #1301 구현·DB·배포 완료. 최종 preview 6v9dwp8dg 로그인 화면을 열어 둠. 실제 선생님 계정에서 교재 확대/뜻 가리기/위치 복귀·주의점 편집 화면 확인 대기. 합성 계정의 배포 교사11/학생7흐름 및 실제 DB 롤백 검수와 구분. 실자료에 검수 표현·주의점 기록 없음. 상세 `docs/verification/classroom-textbook-notes-20260910.md`.
