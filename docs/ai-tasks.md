...
## Codex-1 (codex/*)
### doing
- **수업 실제 브라우저 검수·보정 (2026-09-10)** — #1299 실계정 별도 검수 수업4표현/노트233 저장·판 연결·수동 뜻 보존 확인. Gemini400 설정, 빈 뜻 재조회, 뷰어 수업 복귀 보정9db011dc. 집중91·격리 브라우저27흐름 통과. 새 배포66k1i3x5w READY·버전 일치, CI34425977174 전체373파일/4,075개·빌드·학습 e2e 통과. 새 원점의 교사 이메일 로그인 후 실제 AI 응답 확인 대기. 기존 수업 내용·단어338개/FSRS 지문 동일. 학생 사본은 후속.

### todo
- **수업 후속** — #1299 코드·운영 DB·실계정 저장 검수 및 발견 오류 보정 완료, 새 배포에서 실제 AI 재검수 대기. 다음은 학생 사본의 조회 실패/동시 복제 중복 방지·새 버전 선택 갱신·수업 복귀 및 로그인 후 표현 저장. 운영 웹 병합은 Claude 창구. 상세 `docs/manabi-classroom-phase1.md`.
