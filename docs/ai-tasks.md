...
## Codex-1 (codex/*)
### doing
- **작업 마무리 자동화 (2026-09-18, 오너 직접 요청)** — #1321의 기존 QA에 최종 후보 재검수·결과 리뷰·다음 방향 결정을 연결. `scripts/qa-closeout*`, QA 문서/명령, 공통 규약의 완료 절만 담당. 합성 PASS와 과제 완료 구분, 누락/오래된 증거 거절, 기존 데이터·운영/DB/환경 설정 불변. 다른 프로젝트 예약 자동화는 대상 아님.
