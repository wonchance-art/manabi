...
## Codex-1 (codex/*)
### doing
- **설명판 계정 저장·지난 판 1차 (2026-09-16, 오너 착수 승인)** — `codex/teaching-board-cloud-20260916`, 선행 #1316 검수 head240e32d7 기반. 기존 기기 판 보존, 교사 소유권·불변 페이지 업로드·revision 충돌 복구·저장 상태·지난 판 열기. 개인 노트/학생 수업 기록/SRS는 유지. SQL은 검토 가능한 코드로 준비하며 운영 DB 적용·merge는 별도. world 규약 비대상.
