...
## Codex-1 (codex/*)
### doing
- **뷰어 문맥 뜻 실계정 확인·단일 의미 보완 (2026-09-19)** — #1321 a1949db9 정상 계정에서 명시 후보 선택→자료 저장→새로고침 유지·사전 후보 보존·조회 초점 확인. 실제 AI가 접대 문맥에도 ‘접대하는 사람 또는 주최 측’을 함께 내고 일본어 主催者로 이어지는 의미 혼합 재현. 문맥 후보 프롬프트의 기존 뜻 유도 제거·한 의미 선택 지침과 회귀 검사·캐시 판본만 보완한다. 합성 통과로 의미 정확성을 대신하지 않고 새 Preview에서 실제 재검수. DB/env/공유 사전/개인 SRS·운영 병합 제외. 최종 결과는 #150/closeout.
