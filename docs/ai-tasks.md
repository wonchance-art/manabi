...
## Codex-1 (codex/*)
### doing
- **manabi 웹 v2 · 복습 화면 개편 (2026-09-06, 오너 후속 작업 승인)** — `codex/web-v2-review-20260906`, base #1281. 오늘 복습 직접 진입·빈/실패 상태·집중 세션·원문 왕복을 개선하고 기존 FSRS/출처/채점 경로를 보존. 독립 작업 공간, PDF·음성 제작·DB·월드 제외.
### todo
