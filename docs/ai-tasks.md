...
## Codex-1 (codex/*)
### doing
- **원본 선택 구간 학습 구현 (2026-09-08, 오너 설계 승인)** — `codex/source-passage-study-20260908`, 부모 #1290 b01407fe. 본문/PDF 한 쪽/EPUB 한 장 선택→비공개 학습 구간→기존 표현/복습→원본 복귀. SPEC `docs/manabi-source-passage-study.md`. 원문/판본/개인 권한/복습 일정 보존. PDF 조판·음성·월드·자동 OCR 제외. 구현·테스트·격리 DB·직접 화면 검수 후 draft PR 인계; merge/force-push 없음.

### todo
- **서재 후속 우선순위** — 새 첨부 원본의 선택 구간 학습은 doing. 미참조 업로드 정리·URL 본문 가져오기·기기 간 위치 동기화는 후순위. 단일 편집기/수정/통합 서재는 #1288/#1289/#1290에서 완료. #1288 → #1289 → #1290 순서의 검토·병합은 Claude 창구로 인계. 상세 `docs/manabi-library-v4.md`.
