...
## Codex-1 (codex/*)
### doing
- **manabi 웹 v2 · 출시 통합 준비 (2026-09-07, 오너 운영 반영 설계 승인)** — `codex/web-v2-release-20260907`, base #1286 `698e63e8010aabc883ebdbd5520d8c045cde15c0`. 누적 8개 PR을 main 대상 draft PR 하나로 정리. 실제 배포 버전·Node 24·DB 이력 대조·고정 검수 주소·운영 전환/복귀 검수. 운영 DB/판본/개인 기록과 원본 작업 공간 보존. merge는 Claude 단일 창구.
### todo
