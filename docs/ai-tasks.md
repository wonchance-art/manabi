...
## Codex-1 (codex/*)
### doing
- **N5 가타카나·필기 보강 (2026-09-26, 오너 다음 진행 승인)** — 기존 PR #1324와 격리 clone /private/tmp/manabi-n5-study-routes-20260925, codex/n5-study-routes-20260925에서 진행. 고정 후보 c04e4e451a9ddc602fce8260 위에 문자 준비 3쪽/9문항과 42과 선택 연습 2쪽/6문항을 새 ID로 추가. 기존 렌더·접힌 해설·브라우저 답안 저장 재사용, 문자표/설명 왕복·선행 어휘·정답 유일성·기존 판본/출처/진도 보존 검수. 담당: 신규 manifest/builder/계약·새 판본·해당 e2e·검수 문서·자기 보드. 운영 발행/merge/DB/env/PDF/새 음성 제외.
