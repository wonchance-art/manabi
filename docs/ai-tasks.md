...
### done
- **설명판 수업 동선 개선 구현·로컬 검수 (2026-09-12)** — `codex/teaching-workspace-20260912`, 실행 83246d01, 운영 0a071374 기반. Excalidraw 재사용, 공통 도구/가변 분할, 빠른 표현·로컬 검색, 보여주기·뜻 공개·레이저·Esc 복귀, 과 이동/입력 초안 보존. 모바일 겹침/빈 판/undo·redo/키보드 입력 공간 보완. 전체388파일/4,191개, build475페이지, lint, Chromium 마우스·터치 각18흐름 PASS/오류0. 기존 판/출처/권한/기록 보존, DB/env/운영 변경 없음. 원격 CI·미리보기·exact head는 PR/#150 CODEX_DONE에 기록. 실제 iPad/Pencil·Safari·최종 실계정 검수, 서버 동기화·필기 인식·재사용 묶음은 후속. 상세 `docs/verification/teaching-workspace-20260912.md`.
