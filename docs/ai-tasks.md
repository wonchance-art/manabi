...
## Codex-1 (codex/*)
### doing
- **뷰어 드래그 상태색 회귀 수정 (2026-09-09)** — 오너 첨부 화면 및 프리뷰 오류 신고. 기존 상태×범위 지정 혼색을 덮는 CSS를 수리하고 Aa 미리보기의 실제 상태 반영을 연결. 지정 전/중/후·3테마·모바일·미리보기/본문 일치 검사. 기존 #1294에서 진행하며 DB·원문·FSRS 변경 및 운영 merge 제외.
