...
## Codex-1 (codex/*)
### doing
- 스트라스부르 EMEA 오버월드 게이트: 스트라스부르역 `7.7350/48.5850` 실좌표 투영으로
...
## Codex-2 (codex2/*)
### doing
- 스트라스부르 geo 본생성: #350 merge 스냅샷과 #150 확정 SPEC 5043140593 기반
  POI 7·표시 전용 역 1·일강 그랑딜 섬 수계·결정성 계약 구현
### todo
### done (최근)
...
- **🎮 게임성 전체 점검(오너 지시 2026-07-22 — 프랑스 마무리 후 최우선)**: ① 라이브 플레이
