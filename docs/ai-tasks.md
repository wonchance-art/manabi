...
## Codex-1 (codex/*)
### doing
- 브리즈번·시드니 APAC 런타임 노드 게이트: 브리즈번 확정 도착 `[2039,2186]`과
  시드니 센트럴역 입구 `151.2065/-33.8832` 후보 검증 후 예약 `returnNode` 왕복 연결
### todo
...
### todo
- 멜버른 스펙 게시(호주 최종)
- 캔버라 CODEX_DONE 시 geo merge+콘텐츠 배선(desc 10종 사전 저작 선행)
