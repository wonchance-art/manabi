...
## Codex-1 (codex/*)
### doing
- **기기 간 원본 읽던 위치 동기화 (2026-09-08, 오너 후속 착수 요청)** — `codex/original-reading-sync-20260908`, 부모 #1291 98415d70. 작성 본문/PDF 쪽/EPUB 장·텍스트 위치, 계정별 저장·복원·오프라인/충돌 안내. SPEC `docs/manabi-original-reading-sync.md`. 원문/첨부/학습 진도/표현/FSRS 보존. 격리 SQL·두 브라우저 저장소·기존 흐름·전체 테스트·화면 검수 후 draft PR 인계. merge/force-push/운영 웹 승격 없음.

### todo
- **서재 후속 우선순위** — 선택 구간 학습은 #1291에서 구현·DB 적용·실계정 검수 완료. 다음 후보는 기기 간 원본 읽기 위치 동기화, 미참조 업로드 정리·URL 본문 가져오기는 별도 범위. 단일 편집기/수정/통합 서재/구간 학습 #1288 → #1289 → #1290 → #1291 순서의 검토·병합은 Claude 창구로 인계. 상세 `docs/manabi-source-passage-study.md`.
