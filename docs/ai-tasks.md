...
## Codex-1 (codex/*)
### doing
- **manabi 웹 v2 · 운영 전 인증·권한 점검 (2026-09-07, 오너 다음 진행)** — PR #1287 후속. 실제 anon 역할에서 개인 자료/진도/PDF/표현/Storage 접근0 확인. Google OAuth 콜백 경로와 callback 내부 복귀 경로를 보완한다. 운영 DB 프로필 초기화·권한 점검의 별도 수정안은 오너에게 비공개 검토 자료로 제공한다. 실제 계정 로그인은 대기, migration/merge는 기존 담당 구분 유지.
### todo
