...
## Codex-1 (codex/*)
### doing
- **N5 교재 연습 명칭·한자 노출 감사 (2026-09-25)** — 오너 명칭 변경 및 다음 작업 승인. 기존 #1324의 격리 checkout에서 교재 안 연습/마무리 명칭과 하단 저장표현 복습 구분. 42과 본문 첫 한자/읽기 도움/무독음 회상 위치를 감사하고 근거가 있는 오류만 최소 보완. 원본/이전 판본/출처·문항ID·답안 키/개인 진도·SRS 보존. 재생성/구조·웹 전체 검사/빌드/실제 두 브라우저·모바일·키보드 및 별도 Preview/최종CI/closeout. 운영 발행·merge·DB/env·PDF·신규 음성 제외. 실계정/독립감수/물리기기는 별도.
