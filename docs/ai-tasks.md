...
## Codex-1 (codex/*)
### doing
- **설명판 빠른 도구 운영 반영 (2026-09-14)** — #1311 구현·로컬 검수와 실행 head CI 완료. Preview447anhfbo 실제 글꼴 빌드 완료, 최종 버전·화면 확인 후 최신 head CI와 승인된 squash 병합·운영 배포를 이어감. 원본 공간/다른 변경/DB/환경 보존. 추가 사용자 승인 불필요. 최종 결과는 #1311/#150.
