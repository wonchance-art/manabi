...
### done
- **뷰어 문맥 뜻 선택 구현 (2026-09-18)** — #1321 e8485f19. 중국어 사전 후보/AI 문맥 후보의 명시 선택과 자료 토큰 한정 저장, 조회·저장 실패/늦은 응답/계정 분리, 일본어 조회 후 키보드 초점 유지. 하단 개인 단어 저장·SRS·공유 사전 보존, DB/env 변경 없음. 관련34·전체429파일/4,581PASS(기존1SKIP), JS/JSX lint·Chromium/WebKit reader6단계 통과; 최초 기존 콘텐츠 시간 초과는 동시2 재검수 PASS. 실계정/독립 의미 감수는 완료로 세지 않음. 최종 exact head·CI·배포는 #150 CODEX_DONE 정본. docs/verification/viewer-context-meaning-20260918.md.
