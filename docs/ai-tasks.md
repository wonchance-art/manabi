...
## Codex-1 (codex/*)
### doing
- **뷰어 실자료 검수 재개 (2026-09-09)** — 오너 “재개 해줘”. 고정 preview의 기존 HSK6 세션을 사용하며, 승인된 ed32d1ef에 검수 alias 연결. 실자료에서 발견한 Aa 미리보기의 중국어 명조 상속 오류를 수정하고 표시/복귀를 검수. 원문·복습 채점 변경 및 운영 merge 제외.
