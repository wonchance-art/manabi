...
## Codex-1 (codex/*)
### doing
- **manabi 웹 v2 · 1차 구현 (2026-09-06, 오너 직접 승인)** — `codex/web-v2-phase1-20260906`, 배포 기반 `ae0e4251b8df66e8fa28229e32809ab49c217944`. 공통 탐색·오늘·책장/책 홈·발견 입구·프랑스어 입력·이미지 폴백. 기존 개인 기록/판본/FSRS 보존. 별도 worktree에서 작업, 도시 생성·공유 월드 파일·PDF/음성 제외. PR #1280 위에 검토용 변경 준비; merge/force-push 없음.
### todo
