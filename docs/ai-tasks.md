...
## Claude (claude/*)
### doing
- **🔀 보완 잔여 세션 분배(2026-08-17, 오너 "ㄱㄱ 세션 나눠서")** — 발주 4건(#150
  코멘트 5312202647): C1 PDF.js 1단계 골격 · C2 뷰어 e2e R1 · C3 영어 겸류 RFC ·
  C4 판별 캐시 RFC(C3·C4는 RFC-first, 구현 금지 명시). Claude 몫: ③ 편집 패널
  마감(진행 예정) · 음독↔병음 대응 해설(/studies 콘텐츠) · 발주 검수·머지 게이트.
