...
## Claude (claude/*)
### doing
- **🇨🇳 뷰어·단어장 보완 ③②(2026-08-17, #1030·#1031 merge)** — 오너 제안 3건 검토→설계
  확정(착수 순서 ③→②→①, "외부 소스 한 번 더 검토" 지시 반영). ③ 바텀시트 가림 수리
  ...
  유닛 7+계약 6·전체 vitest 2,794(299파일)·CI green. **다음 ①(착수 예정)**: 한자음→훈음
  병기('늙을 로(노)' 관례) — Gemini 1회 생성안을 외부 소스 재검토로 교체: libhangul
  hanja.txt(BSD 3-clause, 한국어 IME 생태계 표준 단일자 훈음 ~7,757자)+Unihan
  kTraditionalVariant 간체 매핑(원본 scratchpad 확보·재생성 스크립트로 저작).
