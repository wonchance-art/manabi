...
## Codex-1 (codex/*)
### doing
- 멜버른 APAC 런타임 노드 게이트: 플린더스 스트리트역 후보 도착 `[1862,2442]`,
  offset `[0,0]`과 확정 `returnNode: 'melbourne'`를 연결해 EXIT 왕복·상호작용 반경 회귀 계약 구현
### todo
...
### todo
- 렌더크래프트 프롭 라운드(파리·MSM·홍콩·타이베이·런던·베이징·호주 4 — 도시별 랜드마크 실루엣)
