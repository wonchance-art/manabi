...
## Codex-1 (codex/*)
### doing
- **수업 Safari 계열·터치 검수 (2026-09-10)** — 오너 다음 진행, 기존 #1301의 3b029659 최종 CI34459321045 SUCCESS 확인. 같은 PR의 교사 확대/주의점 및 학생 기록 e2e에 WebKit·터치 입력 검수를 추가한다. 실제 교재/개인 단어/수업 노트 검수 쓰기 없이 합성 DB 검수, 실제 계정은 최신 preview 로그인 후 읽기 재확인. 물리 iPad와 구분.
