...
### doing
### todo
- **manabi 운영 후속 대기** — DB 프로필 초기화·권한 수정안은 오너 비공개 검토 자료로 전달, Codex 적용 권한 또는 Claude 인계 결정 대기. 실제 검수용 인앱 브라우저 세션 사용 승인은 자동 승인 검토 거절 후 요청한 상태. 실제 계정 쓰기/두 계정 권한 검수, Claude migration 번호 정합화·병합, 자동 도메인 할당 분리와 production 대기 빌드가 남았다.
