...
## Codex-1 (codex/*)
### doing
- **뷰어 저장 보호·N5 전권 감사 착수 (2026-09-24, 오너 로드맵 승인)** — 일반 자료 교정을 서버 이전 토큰 비교/한 토큰 갱신으로 변경, 같은 토큰 충돌 시 선택 유지/최신값 확인, 서로 다른 수정·권한·재분석·실패 회귀 검사. 기존 발췌 교정·개인 뜻/SRS 보존. 별도로 발행 N5 42과의 구성/범위/문제·해설·선수학습 감사 기록. 이번 완료 단위는 저장 보호 구현·검수와 전권 감사 결과이며 기존 발행 원고/운영DB/env/운영 병합은 별도 적용 단계. 담당: ViewerPage/교정 helper·패널·SQL·관련 검수와 교재 감사 문서/스크립트, 자기 보드. 격리 clone /private/tmp/manabi-classroom-release-20260924, codex/classroom-release-20260917, 기반5fd604ff.
