...
## Codex-1 (codex/*)
### doing
- **설명판 전체 화면·아이콘 메뉴 개편 (2026-09-14)** — 오너 후속 개선 요청으로 6개 아이콘 크기를 유지하면서 선택/펜/지우개 한 번 전환, 선택 도구 재클릭 설정, 메뉴 분류·첫 사용 안내를 추가 검수 중. 오너의 화면 최대 활용/판 안 아이콘 메뉴 요청. 기존 초점 보완 8c37142를 보존하고 `codex/teaching-board-immersive-20260914` 분리. 설명판/도구/수업 연결 컴포넌트·관련 CSS·작업 공간 설정·회귀 검사·기획 문서·자기 보드만 수정. 저장·원문·권한·복습·DB·환경·원래 작업 공간 보존. 실행 a617389ef6381c190c261a1aaccb23fda452070f/PR #1311 공개. 전체389파일/4,195개, Chromium19+6/WebKit터치19+6 흐름 모두 통과·오류0, 354px부터 실제 화면 검수. src 차이 없는 마무리 f74f442와 검수 문서33868de는 로컬 보관. CI34827611413 최종 조회·추가 push가 자동 승인 검토의 모델 용량 오류로 거부되어 미리보기/운영 merge·배포는 미완료. 기존 승인 유효, 외부 기능 복구 후 최신 head 검증부터 이어감. 상세 docs/manabi-teaching-board-immersive.md.
