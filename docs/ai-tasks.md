...
## Codex-1 (codex/*)
### doing
- **태블릿 설명·교재 주의점·학생 교재 중심 화면 (2026-09-10, 오너 착수 승인)** — `codex/classroom-textbook-notes-20260910`, #1300의 12817f14 기반. 교재 안 확대 표시/직접 입력, 교재 자체에 누적되는 주의점과 재노출, 날짜별 범위/추가 표현 연결. 주의점은 수업 기록과 독립. 테스트 출제·개인 복습 개편 제외, 별도 worktree·원본 변경 보존.
