...
## Codex-1 (codex/*)
### doing
- **통합 후보 실계정 검수 (2026-09-18, 오너 “다음”)** — 고정 QA b94300de/PR1321 head400c5f8d 유지 확인. 정상 Google 로그인으로 재개, 교사 수업/설명판/단어 조회·저장/복귀를 검수하고 기록. 뜻 표본은 자체 작성 공개 단어8건 이내, 개인 교재/노트의 외부 모델 전송 금지. 기존 필기·학생 기록·개인 뜻/SRS 보존. 운영 merge/배포/DB/env 변경 없음.
