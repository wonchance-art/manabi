...
## Codex-1 (codex/*)
### doing
- **설명판 후속 A/B/C (2026-09-17, 오너 설계 승인·작업 개시)** — `codex/classroom-refinements-20260917`, #1319 exact bcce8f12 기반 격리 worktree. 기간/30개씩 목록·현재 수업 재사용, 합성 부하 측정 후 병목 보완, 일본어/중국어 표시 계약 검증. 범위: 관련 classroom UI/CSS·목록 API/client/model·저장/레이아웃 필요한 부분·관련 테스트/E2E·검수 문서. 원문/학생/SRS/DB/env/운영 merge 제외. 원격 상태로 로그인 요청 없이 자동 검수, 실계정/물리 기기는 귀가 후. 설계 `docs/manabi-classroom-refinements-20260917.md`.

### todo
- **설명판 병합·기기 후속 (2026-09-16)** — #1317 코드·DB 적용·실제 교사 저장/재접속/지난 판 검수 완료. #1316/#1317 운영 merge는 별도 승인. 물리 iPad/Pencil·손바닥 접촉·소프트 키보드·회전, 별도 학생 계정, 100개 초과 목록·미참조 객체 수거는 후속. 페이지 전체 복사는 #1318, 요소 부분 복사는 #1319 구현·배포 검수 완료. #1318/#1319 최종 fq12zobov Preview 실계정 복사/저장/재접속과 #1316 개인 노트 누적 정리는 로그인 후 확인. Safari 자동 검수의 RSC prefetch 오류는 아래 후속으로 해결.
