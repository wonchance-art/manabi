...
### todo
- **수업 원본 직접 단어 저장 활성화 (2026-09-17)** — #1321 SQL20260917023410 운영 적용 승인 요청 중. 기존 자료/SRS 행 변경 없는 class 문맥·개인 발췌 정책·원자적 저장 함수. 승인 후 기존 RPC 호환/권한/원격 저장 확인. 운영 웹 merge/승격·영구 env/alias는 별도. 실계정 로그인과 물리 iPad/Pencil 검수는 사용자가 가능할 때 진행.
