...
## Codex-1 (codex/*)
### doing
- **manabi 웹 v2 · 연속 탐색·집중 뷰어 (2026-09-07, 오너 다음 ㄱㄱ)** — `codex/web-v2-focused-reader-20260907`, base #1285. 빠른 연속 탐색에서 URL/본문 불일치 재현·수리, 긴 글 뷰어의 집중 읽기와 필요한 도구 노출. Layout·MaterialsPage·LibraryPage·DiscoveryExplorer의 탐색 연결, ViewerPage/읽기 설정·관련 CSS·helper·테스트·검수 문서 및 자기 보드만 수정. 원고·토큰 조판·FSRS·DB·환경·음성·PDF 조판·월드 제외. 글 전체 북마크는 후속 별도 저장 모델 범위. 별도 작업 공간, 원본 변경 보존.
### todo
