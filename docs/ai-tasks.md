...
## Codex-1 (codex/*)
### doing
- **개인 노트 인식·미리보기 마무리 (2026-09-15)** — PR #1313, 실행 e7f070d8. 오너 공개 push/PR/미리보기·선택 영역 Gemini 전송 승인. 구현 및 로컬 전체398파일/4,248테스트·build/lint, Chromium/WebKit 각9흐름·교사13흐름 PASS. Preview 1uoqwksoa 배포 완료/버전 확인과 실계정 로그인 검수 진행. 운영 merge·DB/schema·환경 변경 없음.
