...
## Codex-1 (codex/*)
### doing
- **개인 필기 노트 → 단어 일괄 정리 (2026-09-15, 오너 착수 승인)** — `codex/personal-study-notes-20260915`, main 9a7e3be1 기준 독립 worktree. 기존 자료 소유권·설명판·어휘 문맥 저장을 재사용해 개인 노트, 기기 초안/서버 저장, 가나 후보, 일괄 검토·저장을 구현·검수한다. 수업 공용 기록·기존 복습 일정은 보존. 신규 DB 스키마·운영 설정 변경 없이 진행하며 외부 파일 노트 반입은 후속.
