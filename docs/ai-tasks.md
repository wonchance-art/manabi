...
## Codex-1 (codex/*)
### doing
- **서재 저장 후 편집 착수 (2026-09-08, 오너 승인)** — `codex/material-editing-20260908`, 부모 #1288 head93d7607d 고정. 기존 편집기 재사용, 제목·본문·첨부 수정과 과거 학습 출처 보존. 상세/허용 범위 `docs/manabi-material-editing.md`. 운영 DB/merge는 이번 검토 완료 후 별도 게이트; 기존 원본 체크아웃 불변.
