...
## Codex-1 (codex/*)
### doing
- **여러 표현·필기 중심 설명판 (2026-09-14)** — 오너가 확정 설계와 글자만/카드·여백 조절·오른쪽 뜻·독음/훈음 토글을 승인하고 구현 착수 지시. `codex/teaching-word-canvas-20260914`, 기준 main 663288eba51310413e7e28107aac02e4cbd37044. 표현 조회·직접 수업 기록·목록과 실제 화면 검수까지 연결. 원본 작업 공간·다른 PR·교재·개인 복습·DB/환경 보존. #1311 운영 완료는 #150 최종 기록 참조.
