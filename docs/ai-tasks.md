...
## Codex-1 (codex/*)
### doing
- **운영 확대 설명 초점 복귀 보완 (2026-09-14)** — 오너의 병합·배포·검수 전체 승인에 따른 마지막 실계정 회귀 수정. main e29d41a7에서 `codex/viewer-preview-return-focus-20260914` 분리. 단어 ‘크게 보기’에서 Escape/닫기 후, 잠시 숨겨진 원래 버튼에 초점을 복구한다. TeachingPresentation·해당 브라우저 검사·검수 문서·자기 보드만 수정. DB·환경·기존 자료 및 다른 작업 보존.
