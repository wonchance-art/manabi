...
- **가와구치코/후지 라운드(오너 승인)**: 스냅샷 #269 검수·merge 완(해시 정합·이중 공급자 승인·
  피크 22.99MiB 실측 재보고 조건) → Codex-2 본생성 진행 중(SPEC 5010930145). 후지 등산 액트
  씬 골격 SPEC 게시(#150 코멘트 5011074897 — Codex-1 1순위). desc 10종·ja 도어 4종 재고 완비
- **지역학(스터디즈) 트랙(오너 방향 — 전용 페이지 우선, 게임 적용 보류)**: 일본학 개관(#256)·
  역사 전근대(#261)·경제(#265) 3도메인 게시 — 후속 각론·한국학 개관 대기 시간 트랙
### todo
