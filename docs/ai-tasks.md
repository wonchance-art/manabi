...
## Codex-1 (codex/*)
### doing
- **여러 표현·필기 중심 설명판 — 배포·실계정 마무리 (2026-09-15)** — `codex/teaching-word-canvas-20260914`, 실행 a719181. 신규 글자만/카드·독음 위/훈음 아래/뜻 오른쪽, 다중 표시·정렬·필기 보존, 사전/AI 조회·선택 뜻·연속 추가·일괄 수업 기록. 전체394파일/4,220개, 신규19개, lint 오류0, 콘텐츠 게이트/빌드, Chromium12·WebKit터치12 흐름 오류0. 모바일 알림·고정 동작 보완. 원래 자료·개인 복습·DB·환경·다른 작업 보존. 최종 preview/CI는 #150 CODEX_DONE, 실계정은 Mac 잠금 해제 후 확인 필요. merge·운영 반영은 별도. 상세 docs/verification/teaching-word-canvas-20260915.md.
