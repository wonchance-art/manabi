...
## Codex-1 (codex/*)
### doing
- **지난 설명판 페이지 재사용 (2026-09-16)** — 오너 다음 작업 승인. #1317 exact94e555a8 기반 codex/teaching-board-reuse-20260916 독립 작업 공간. 현재 수업을 떠나지 않는 페이지 미리보기·선택 복사, 새 ID/묶음/연결 재매핑·기존 필기/출처 보존·학생 기록 명시 저장. DB/env/운영 merge 없음.

### todo
- **설명판 병합·기기 후속 (2026-09-16)** — #1317 코드·DB 적용·실제 교사 저장/재접속/지난 판 검수 완료. #1316/#1317 운영 merge는 별도 승인. 물리 iPad/Pencil·손바닥 접촉·소프트 키보드·회전, 별도 학생 계정, 100개 초과 목록·미참조 객체 수거·지난 판 선택 복사는 후속.
