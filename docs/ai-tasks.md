...
## Codex-1 (codex/*)
### doing
- **manabi 웹 v2 · 승인된 Node 24 전환 (2026-09-07)** — 오너 「승인. 다음 할 일 진행」으로 package/lock engines 20→24, 웹 CI 22→24의 세 파일 변경 승인. `codex/web-v2-release-20260907` / draft PR #1287에서 실제 Vercel Node24 빌드·웹 회귀·고정 미리보기를 검증한다. world CI/자산 저작은 Node22 유지. DB 이력 정합화와 병합은 Claude 소유이며 운영 주소/개인 기록은 보존한다.
### todo
