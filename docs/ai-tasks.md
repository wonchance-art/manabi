...
### todo
- **검수 자동화 후속 (2026-09-17)** — 공개 배포 사전 검사에서 최신 후보1a21318f PASS/고정 QA 주소2932e889 불일치 확인. 고정 주소 연결안과 정상 인증 교사/학생 검수 묶음은 docs/qa-live-workflow.md. alias 이동·OAuth 설정·실계정은 별도 단계이며 이번 규약 승인에는 포함하지 않음. 승인 화면 비교/접근성·실제 모델 의미 평가·교재 커버리지 확장 후속. 병렬 세션은 통합·품질/교재/제품 기능 3역할 제안, 실제 생성·기존 담당 변경 없음.
