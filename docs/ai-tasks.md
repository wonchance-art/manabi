...
## Codex-1 (codex/*)
### doing
- **뷰어 디자인 일관성·설명판 단어 창 (2026-09-13)** — 오너의 메인 페이지 기준 뷰어 디자인 개선 요청. `codex/viewer-manabi-design-20260912`, #1308의 9040b216 기반 별도 작업 공간. 기존 뜻 카드/저장 동작을 재사용해 설명판에서 복원하고, 메인 종이색·서체 위계·도구/패널을 정리한다. 원문·DB·복습 기록·권한·운영 배포 보존. 상세 `docs/verification/viewer-manabi-design-20260913.md`.
