...
## Codex-1 (codex/*)
### doing
- **설명판 전체 화면·아이콘 메뉴 개편 (2026-09-14)** — 오너의 화면 최대 활용/판 안 아이콘 메뉴 요청. 기존 초점 보완 8c37142를 보존하고 `codex/teaching-board-immersive-20260914` 분리. 설명판/도구/수업 연결 컴포넌트·관련 CSS·작업 공간 설정·회귀 검사·기획 문서·자기 보드만 수정. 저장·원문·권한·복습·DB·환경·원래 작업 공간 보존. 외부 조회와 브라우저는 자동 검토의 모델 용량 오류로 차단되어 로컬 구현부터 진행.
