...
## Codex-1 (codex/*)
### doing
- **화면·접근성 회귀 및 의미 검수 기준 (2026-09-17, 오너 “진행해”)** — #1322 exact e43d48aaf4b60396f98eb8f7885ba87fe459709d 기반 별도 codex/visual-quality-20260917. 기존 뷰어/뜻 창/설명판/개인 노트 실제 컴포넌트 QA·화면 증거·접근성·검출 canary와 중국어/일본어 출처 기반 의미 검수 자료 담당. e2e·scripts/qa 관련·테스트 의존성·발견된 해당 UI 결함·검수 문서만 수정. 실제 AI 평가/외부 개인 문장 전송/교재 판본/PDF/음성/DB/env/alias/운영 merge 제외. 원래 작업 공간·다른 담당 영역 보존.

### todo
- **검수 자동화 후속 (2026-09-17)** — 고정 QA 주소를 최신 후보1a21318f에 연결하고 공개 사전 검사 PASS. 남은 것은 OAuth 허용 목록·정상 인증 교사/학생 검수, 승인 화면 비교/접근성·실제 모델 의미 평가·발행 N5 42과 커버리지. 다음 추천은 화면 품질 회귀 기준과 중국어/일본어 의미 정답셋 준비이며 로그인 없이 진행 가능. PDF/신규 음성 보류. 병렬 세션은 아직 생성하지 않음. docs/qa-live-workflow.md.
