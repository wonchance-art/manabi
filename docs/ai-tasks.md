...
### todo
- **개인 노트 후속 (2026-09-15)** — 공개 push/draft PR/미리보기와 사용자가 선택한 필기 영역만 Google Gemini로 전송하는 인식 기능을 오너가 승인. PR #1313에서 구현·검수 중. 전체 노트/교재 자동 전송·운영 병합·DB/env 변경은 제외. 물리 iPad/Pencil·실계정 간 이어 쓰기·외부 PDF/이미지 반입은 별도 후속.
