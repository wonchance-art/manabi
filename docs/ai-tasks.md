...
## Codex-1 (codex/*)
### doing
- **여러 표현 설명판 실계정 확인 대기 (2026-09-15)** — #1312 구현·미리보기 검수 완료(done 참조). Mac 잠금으로 실계정/실제 AI 응답 검수 미완료. 새 Preview ah6d78020에서 교사 로그인 후 교재→뜻→여러 표현/필기→수업 기록을 확인할 것. 물리 Pencil은 별도. 운영 병합 승인·반영은 별도이며 기존 수업/개인 자료를 검수용으로 임의 수정하지 않는다.
