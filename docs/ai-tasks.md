...
## Codex-1 (codex/*)
### doing
- **manabi 웹 v2 · 내 서재 분류·발견 필터 (2026-09-06, 오너 후속 승인)** — `codex/web-v2-library-discovery-20260906`, base #1282. 읽는 중·내 자료·노트 분류, 지역학 지역/주제 검색, 실제 주소·진도·개인 권한 보존. 별도 작업 공간에서 진행; DB·PDF 조판·음성·월드 변경 없음.
### todo
