...
## Codex-1 (codex/*)
### doing
- **N5 32·39과 누적 회상 동선·문항 지시 정리 (2026-09-25)** — 오너 다음 진행 승인. PR #1324의 격리 작업 공간에서 계속. 32과 본학습/누적 복습 구분, 39과 기존 장면·실전 흐름 보존 및 다음 날/누적 복습 구분, 필요한 앞 과 링크·명시적 지시문 보완. 기존 판본/페이지·문항ID/답안 키/출처 보존. 새 후보 재생성·관련/전체 검사·제품 빌드·실제 앱 두 브라우저/모바일/키보드·별도 Preview·closeout까지. 운영 발행/DB/환경/PDF/새 음성/merge 제외. 실제 계정·물리 기기 검수는 별도이며 합성 결과에 포함하지 않음.
