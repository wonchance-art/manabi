...
## Codex-1 (codex/*)
### doing
- **설명판·뷰어 운영 마무리 (2026-09-14)** — 오너가 #1308·#1309 병합·배포·가능한 검수 전부를 승인. #1309를 #1308에 통합한 뒤 main c21859a4로 squash merge했고 검수 tree 동일 확인. 추가 WebKit 터치 검사에서 발표 종료 시 원래 버튼으로 초점 복귀가 누락되는 문제를 발견해 `codex/viewer-release-focus-20260914`에서 실제 열기 버튼을 전달하도록 보완 중. 기존 검사 판정 유지, 원래 작업 공간·자료/DB/FSRS 보존.
