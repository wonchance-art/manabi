...
### todo
- **설명판 운영 적용·기기 후속 (2026-09-16, DB 적용 승인 대기)** — #1317 코드/SQL·로컬 검수 완료, 운영 DB/Storage는 아직 미적용. 승인 후 새 비공개 테이블/버킷 적용→실제 교사 계정 저장/재접속 검수. #1316/#1317 운영 merge는 별도 승인. 물리 iPad/Pencil·손바닥 접촉·소프트 키보드·회전, 100개 초과 목록·미참조 객체 수거·지난 판 선택 복사는 후속.
...
### done
- **설명판 계정 저장·지난 판 구현/검수 완료 (2026-09-16)** — #1317, 선행 #1316 기반, 실행5eda8e64. 교사 비공개 페이지 업로드·원자적 revision·오프라인 초안·충돌 복구·지난 판·기존 로컬 이전. 전체408파일/4,333개·실제 SQL26조건·build480페이지·Chrome/WebKit터치 각22·개인 노트11 PASS. Preview2x9ongcyd의 최종 READY/버전 및 head/CI는 PR/#150 CODEX_DONE 참조. **DB APPLY HOLD/운영 merge 미수행**: 실제 DB 계정 저장은 적용 승인 후 검수하며 학생 기록/개인 SRS/교재/env는 불변. 상세 docs/verification/teaching-board-cloud-20260916.md.
