...
## Codex-1 (codex/*)
### doing
- **뷰어 문맥 뜻 선택 최종 확인 (2026-09-18)** — #1321 구현 e8485f19. 실계정 브라우저 연결 시간 초과로 실제 공급자 후보→자료 저장→재접속→일본어 대응은 미검수. 최종 head CI/Preview/closeout과 재개 조건은 #150 인계에 기록. 운영 전환 전 이 흐름 확인 필요.
