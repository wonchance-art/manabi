...
## Codex-1 (codex/*)
### doing
- **수업 설명판 선택 필기 인식·판 배치 (2026-09-16)** — 오너가 다음 단계 설계 후 ‘ㄱㄱ’로 착수 승인. 개인 노트 #1313 head28c108e1 기반 별도 `codex/classroom-handwriting-20260916`. 선택 PNG/Gemini/후보 처리 재사용, 교사 권한 확인, 가나·뜻 검토 후 여러 표현 판 배치, 명시적 수업 기록 유지. 기존 개인 노트 실계정 검수 병행. 원래 작업공간·교재·개인 단어/SRS·DB/env 보존, 운영 병합 제외.

### todo
- **개인 노트 실계정·기기 검수 후속 (2026-09-15)** — #1313 구현/미리보기 검수 완료. Preview 1uoqwksoa 로그인 화면을 Codex에 열어 두었으며 실제 노트 저장/실제 Gemini 인식은 로그인 완료 후 확인. 물리 iPad/Pencil·실기기 간 이어 쓰기, 수업 설명판 직접 인식, 외부 PDF/이미지 반입은 후속. 운영 병합은 이번 승인 범위에서 제외.
- **여러 표현 설명판 기기 후속 (2026-09-15)** — 물리 iPad/Pencil·손바닥 접촉·실제 소프트 키보드와 별도 학생 계정 검수는 미완료. 줄바꿈/실제 수업 저장/운영 반영은 위 출시 마무리 범위. 기기 간 판 동기화·필기 인식은 기존 후속 범위다.
