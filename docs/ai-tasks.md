...
## Codex-1 (codex/*)
### doing
- **설명판 Safari·실계정 출시 검수 (2026-09-16)** — 오너 「작업 ㄱㄱ」에 따라 #1319 후속. 현재 clean head ed077d50 기반 같은 격리 작업 공간. 관찰된 /home·/class·/study RSC prefetch 취소를 설명판/수업 뷰어의 실제 링크에서 제거하고, 네트워크·탐색·저장 회귀를 검사한다. 허용: TeachingBoardCanvas.jsx, ClassroomReader.jsx, ViewerPage.jsx의 관련 링크 및 해당 E2E/검수 문서/생성 sw/자기 보드. 실계정 복사·저장·노트 정리는 로그인 후 검수. DB/영구 env/콘텐츠/world/운영 병합 없음.

### todo
- **설명판 병합·기기 후속 (2026-09-16)** — #1317 코드·DB 적용·실제 교사 저장/재접속/지난 판 검수 완료. #1316/#1317 운영 merge는 별도 승인. 물리 iPad/Pencil·손바닥 접촉·소프트 키보드·회전, 별도 학생 계정, 100개 초과 목록·미참조 객체 수거는 후속. 페이지 전체 복사는 #1318, 요소 부분 복사는 #1319 구현·배포 검수 완료. #1318/#1319 새 Preview 실계정 복사/저장/재접속은 로그인 후 확인.
