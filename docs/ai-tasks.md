...
## Codex-1 (codex/*)
### doing
- **일본어 대응어 자형 유도 보완 (2026-09-19)** — #1321 9ab60135 실제 승인 조회에서 중국어 한 의미 후보/명시 저장/재접속 통과. 그러나 일본어가 東道主 자형을 대응어로 표시하고 드문 표현이라고 경고하는 모순 발견. 기존 번역 함수·관련 계약 테스트만 보완해 자형 설명과 선택 뜻 번역을 분리하고 캐시 판본 변경. 같은 자체 문장으로 재검수하며 정상 계정·공통 사전·개인 SRS·DB/env/운영 보존.
