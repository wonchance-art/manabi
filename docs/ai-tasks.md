...
## Codex-1 (codex/*)
### doing
- **여러 표현 설명판 출시 마무리 (2026-09-15, 오너 병합·배포 승인)** — #1312 긴 표현 균형 줄바꿈 보완, 실제 수업 표현1건 저장·재조회·중복 거부·운영 기록/원문 복귀 확인. 최종 브라우저·CI 검사 후 최신 head 지정 squash merge와 운영 배포 확인을 진행한다. 물리 Pencil은 별도이며 기록1건 외 개인 단어/복습/교재 주의점 변경 없음.
