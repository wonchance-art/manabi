...
- **🇨🇳 확산 1호 zh 개시(오너 발주 '다음은 중국어')**: Z1 기준표(#777) — 78챕터·HSK 대조,
  ...
  **Z3 드릴 완결(#781~#787)**: 전 78챕터 드릴 484문항(+장면 sq 24 별도) — OT·발음·H1 120(#781, red merge 사고 → #782 수리·&& 게이트 명문화) →
  H2 72(#783)·H3 78(#784)·H4 60(#785)·H5·H6 90(#786)·장면 48(#787). 비중복 게이트 zh 일반화 실효(예문 충돌 선적발 누계 19건 전량 교체),
  성조·발음 유사 함정 listen 챕터당 1. 다음 = Z4 써 보기(HSK 서면 표현) → Z5 듣기·감사·종합 평가(오너 지시 "마무리되고 평가까지")
