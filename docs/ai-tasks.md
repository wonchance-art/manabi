...
### todo
- **서재 후속 우선순위** — 새 첨부 원본의 선택 구간 학습. 미참조 업로드 정리·URL 본문 가져오기·기기 간 위치 동기화는 후순위. 단일 편집기/수정/통합 서재는 #1288/#1289/#1290에서 완료. #1288 → #1289 → #1290 순서의 검토·병합은 Claude 창구로 인계. 상세 `docs/manabi-library-v4.md`.
