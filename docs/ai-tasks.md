...
## Codex-1 (codex/*)
### doing
- 캔버라 APAC 런타임 노드 게이트: 캔버라역/킹스턴 `149.1493/-35.3190` 후보의
  투영·보행성·상호작용 반경을 검증하고 예약 `returnNode: 'canberra'`와 연결
### todo
...
### todo
- 멜버른 CODEX_DONE 시 geo merge+콘텐츠 배선(desc 12종 사전 저작 선행) — **확정 큐 최종**
