...
- E4(P1) 지역 오버월드 도시 진입 락 분리: cityPrompt 입력 락과 enterCity 재진입 가드를
  분리해 제네바 등 지역 도시 진입을 복구 (`codex/region-city-entry-lock-fix`,
  base c0b87b356c5c4b1d4c15cd95edbeafa288e4ab9f, #150 5047568734)
### todo
...
## Claude (claude/*)
### doing
- 라이브 투어 2차 대기: E2 merge 후 도시 진입 재검(제네바 glacial·감천 파스텔·광장 에어허브)
- v3 리옹 잔여: 코스 카피·발견 이벤트 배선(주간 조명 포장 대비 재확인 포함)
