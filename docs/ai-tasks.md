...
## Codex-1 (codex/*)
### doing
- **통합 서재 v4 착수 (2026-09-08, 오너 설계 승인)** — `codex/library-v4-20260908`, 부모 #1289/f931588c. 통합 원본 목록·검색/페이지·최근 실제 열람·개인 모음집, 기존 원문/진도/권한 보존. 독립 worktree, 상세 `docs/manabi-library-v4.md`. 운영 merge 없음.
