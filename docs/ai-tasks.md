...
## Codex-1 (codex/*)
### doing
- **최종 미리보기 실제 수업 왕복 (2026-09-11)** — 오너 후속 개시 승인. 26z7kitqi 실제 로그인 확인, 기존 #1301 기록 복귀와 #1300 표현 기록→판→교재 왕복의 남은 실계정 검수를 진행한다. 검수용 수업만 사용하고 생성한 검사 자료를 정리한다. 실제 교재/개인 단어/기존 수업 내용은 보존.
