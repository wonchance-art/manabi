...
## Codex-1 (codex/*)
### doing
- **설명판 표현·필기 부분 재사용 (2026-09-16)** — 오너 승인한 부분 선택 설계 구현. #1318 exact3a171115 기반 `codex/teaching-board-fragments-20260916` 독립 작업 공간. 표현 단위/영역 선택·현재 판/새 페이지 배치·undo·원본/출처/저장 보존·중복 안내·터치/키보드 검수. 허용 범위는 classroom 선택 UI/복제 순수 모델/해당 테스트·E2E·설계/검수 문서·생성 sw·자기 보드. DB/env/운영 merge/원본 교재/학생 기록 자동 변경 없음.
