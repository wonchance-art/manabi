...
## Codex-1 (codex/*)
### doing
- **서재 저장 후 편집 구현·로컬 검수 완료 / 공개 전송 승인 대기 (2026-09-08)** — `codex/material-editing-20260908`, 구현3fbc46b7, 부모 #1288 head93d7607d 불변. 제목·본문·첨부 수정, 자료별 초안, 충돌/재시도, 학습 원문·표현 출처 보존. 전체353파일/3857개, 최종 집중51개, 브라우저15흐름+기존학습20조건,473페이지 빌드, 격리 SQL/IDB 통과. 새 공개 push가 자동 승인 검토에서 거절됨(이전 승인은 다른 브랜치/범위); 현재 로컬만, draft PR·배포·CODEX_DONE 미게시. 문서의 document_json/원문 보호 DDL도 미적용. 새 전송/DB 승인 후 PR·미리보기·실계정 검수로 마무리. 상세 `docs/manabi-material-editing.md`.
