...
## Codex-1 (codex/*)
### doing
- **뷰어 2차** — 승인 설계의 Aa 메뉴·언어별 서체·병음 크기/줄간격·읽기 위치 유지·단어 카드·집중/가림/페이서/받아쓰기 레이어 정리. 신뢰성 1차 #1293 이후 범위. PDF 조판·신규 음성·split view 제외. `codex/viewer-reading-controls-20260909`, 부모 #1293 bb8fc05d. 오너 2026-09-09 “진행해” 승인. SPEC `docs/manabi-viewer-reading-controls.md`.
