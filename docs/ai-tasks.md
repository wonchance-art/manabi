...
## Codex-1 (codex/*)
### doing
- **N5 한자 색인·본문 연결 정리 (2026-09-25, 오너 후속 승인)** — PR #1324/e22566cd에서 착수. 한자 대표 단어·읽기에 맞는 본문/읽기 도움 연결과 기존 관련 과의 역할을 구분. 생성기·색인 검수 자료·새 불변 판본·대상 테스트/검수만 변경. 기존 4판본·문항/출처/입력 키·발행 포인터·SRS 보존. 별도 Preview까지; 운영 발행/merge/DB/env/PDF/새 음성 제외.
