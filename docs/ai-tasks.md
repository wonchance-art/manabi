...
## Codex-1 (codex/*)
### doing
- **설명판 표현·필기 부분 재사용 (2026-09-16)** — 오너 승인한 부분 선택 설계 구현. #1318 exact3a171115 기반 `codex/teaching-board-fragments-20260916` 독립 작업 공간. 실행7b5d8966 로컬 완료: 표현 단위/영역 선택·현재 판/새 페이지 배치·undo·원본/출처/저장 보존·중복 안내. 전체410파일/4,349개·build480페이지·Chrome/WebKit 각33흐름 PASS/오류0, 최종 Chrome 재검수 PASS. 자동 승인 검토의 신규 범위 공개 전송 거절로 push/PR/Preview 승인 대기. 검수 docs/verification/teaching-board-fragments-20260916.md. 허용 범위는 classroom 선택 UI/복제 순수 모델/해당 테스트·E2E·설계/검수 문서·생성 sw·자기 보드. DB/env/운영 merge/원본 교재/학생 기록 자동 변경 없음.

### todo
- **설명판 병합·기기 후속 (2026-09-16)** — #1317 코드·DB 적용·실제 교사 저장/재접속/지난 판 검수 완료. #1316/#1317 운영 merge는 별도 승인. 물리 iPad/Pencil·손바닥 접촉·소프트 키보드·회전, 별도 학생 계정, 100개 초과 목록·미참조 객체 수거·요소 부분 선택 복사는 후속. 지난 판 페이지 전체 선택 복사는 #1318 구현.
