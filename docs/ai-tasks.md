...
## Codex-1 (codex/*)
### doing
- **검수 자동화·협업 정합화 (2026-09-17, 오너 “좋아 적용해”)** — #1321 head34a09fed 기반 독립 worktree/브랜치 codex/qa-workflow-20260917. 필수 검수 묶음·결과/재개 기록·CI 연결·실행 환경·규약 적용 범위를 정리한다. 기존 수업/노트/언어 검사를 재사용하고 합성/실계정/운영 상태를 구분한다. 앱 기능·기존 원고·DB·환경 변수·공유 alias는 변경하지 않는다. 병렬 세션은 역할·파일 소유권·통합 담당 분담안을 제공하며 이번 지시만으로 별도 세션을 생성하지 않는다.
