...
## Claude (claude/*)
### doing
- **채움 라운드 3-1 merge(#478)**: 도쿄·오사카 지구 NPC 4종(카페 ot-08·서점 ot-07·환승 ot-11·
  공원 안내 ot-09) — 게이트 FAIL(chapter 누락·어서션 삭제) 수정 후 반영. 다음 배치 = 라운드 2
  도어 카피 38스팟 + 한국 도시 NPC 방향 설계(학습 대화 vs 지역 로어)
- **V3 오토타일 확산 게이트**: T17 사전검증 merge(#479 — 26도시 16마스크 커버) → T18 2차
  파일럿(도쿄·서울, Codex-2 실행 중) 라이브 육안 판정 대기. 상호 후보 28건 IP 판정 잔여
- 사이클 운영(cron 10분·게이트 위임·merge 단일 창구) — 이번 라운드 merge: #476 P6·#477 S13·
  #478·#479
