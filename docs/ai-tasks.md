...
## Codex-1 (codex/*)
### doing
- **수업·개인 노트 통합 출시 준비 (2026-09-17, 오너 설계 승인·작업 개시)** — `codex/classroom-release-20260917`, #1320 exact46e1fca7 및 main efa44c50 기준 격리 worktree. #1316~#1320 통합 후보, 교사/학생/개인 노트 연결 검수, 일본어 대응 품사 요청/캐시·직접 수정 보존, 근거24사례. 범위: 관련 viewer/reference·notes/classroom 연결·계약/E2E·검수/출시 문서·자기 보드. DB/env/운영merge/원본·개인자료·SRS 일괄 변경 제외. 외출 중 로그인 요구 없이 자동 검수, 실제 계정/기기는 별도.
