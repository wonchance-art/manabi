...
## Codex-1 (codex/*)
### doing
- **N5 시험 영역·전권 문장 1차 검토 (2026-09-25, 오너 진행 승인)** — PR #1324/48a8e204 기반 격리 작업 공간에서 공식 N5 유형과 실제 설명·문항·읽기 근거를 대조하고42과 문장/지시문을 검토. 원문/정답/출처/진도 보존하며 명확한 교정만 새 불변 후보로 생성. 부족 영역은 근거·우선순위로 구분; 청해 신규 제작·PDF·운영 발행/DB/env/merge 제외. scripts/textbook 교정/감사, 신규 후보·대상 검사·자기 문서 담당.
