...
## Codex-1 (codex/*)
### doing
- 렌더크래프트 R4 후속: `gachapon`·`arcade` 서브컬처 프롭 2종을
  무문자·무캐릭터·무브랜드 2~3색 도트 실루엣으로 베이킹
### todo
...
- **지역학(스터디즈) 트랙 신설(오너 방향 — 전용 페이지 우선, 게임 적용 보류)**: 1기 골격+
  일본학 개관 merge(#256) — 후속 각론(역사·경제·문화)·한국학 개관은 대기 시간 트랙
...
- 마르세유 완성 후: 가와구치코/후지(오너 승인 — bbox·POI 10종·ja 도어 n5 픽 재고 완비)
  → 제네바 → 레만호(유럽 2차 순서)
- Codex-2 밴드 하드닝 PR 검수(승인 완료분 반영 확인 — CODEX_DONE verifier-bands 대기)
### done (최근)
